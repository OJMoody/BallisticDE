...
defaultproperties
{
	...
	Begin Object Class=InstantEffectParams Name=ArenaPrimaryEffectParams
		...
		HeadMult=1.4f
		LimbMult=0.5f
		DamageType=Class'BWBP_SKCExp_Pro.DTGRSXXPistol'
		DamageTypeHead=Class'BWBP_SKCExp_Pro.DTGRSXXPistolHead'
		DamageTypeArm=Class'BWBP_SKCExp_Pro.DTGRSXXPistol'
		PenetrateForce=100
		bPenetrate=True
	...
	Begin Object Class=InstantEffectParams Name=ArenaSecondaryEffectParams
		RangeAtten=0.2
		Damage=18
		DamageType=Class'BWBP_SKCExp_Pro.DTGRSXXLaser'
		DamageTypeHead=Class'BWBP_SKCExp_Pro.DTGRSXXLaserHead'
		DamageTypeArm=Class'BWBP_SKCExp_Pro.DTGRSXXLaser'
		PenetrateForce=200
		bPenetrate=True
