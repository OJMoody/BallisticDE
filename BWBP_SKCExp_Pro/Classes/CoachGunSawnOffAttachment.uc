//=============================================================================
// CoachGunSawnOffAttachment.
//
// 3rd person weapon attachment
//=============================================================================
class CoachGunSawnOffAttachment extends BallisticShotgunAttachment;
...
simulated function ShotFireEffects(byte IsDoubleFire)
{
	...
	if (Level.NetMode == NM_Client && FireClass != None)
	{
		if (IsDoubleFire == 0)
		{
			XS = class'CoachGunSawnOffPrimaryFire'.default.ShotInaccuracy.X; 
			YS = class'CoachGunSawnOffPrimaryFire'.default.ShotInaccuracy.Y;
		}
		else 
		{
			XS = class'CoachGunSawnOffPrimaryFire'.default.ShotDoubleInaccuracy.X; 
			YS = class'CoachGunSawnOffPrimaryFire'.default.ShotDoubleInaccuracy.Y;
		}
...
simulated function SlugFireEffects(byte IsDoubleFire)
{
	...
	if (Level.NetMode == NM_Client && FireClass != None)
	{
		if (IsDoubleFire == 0)
		{
			XS = class'CoachGunSawnOffPrimaryFire'.default.SlugInaccuracy.X; 
			YS = class'CoachGunSawnOffPrimaryFire'.default.SlugInaccuracy.Y;
		}
		else 
		{
			XS = class'CoachGunSawnOffPrimaryFire'.default.SlugDoubleInaccuracy.X; 
			YS = class'CoachGunSawnOffPrimaryFire'.default.SlugDoubleInaccuracy.Y;
		}
...
defaultproperties
{
    ...
    FireClass=Class'BWBP_SKCExp_Pro.CoachGunSawnOffPrimaryFire'
