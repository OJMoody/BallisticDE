...
simulated event PreBeginPlay()
{
	...
	{
		FireModeClass[1]=Class'BWBP_SKCExp_Pro.SawnOffSecondaryFire';
	}
}
...
defaultproperties
{
    ...
    bRightLoaded=True
     ...
     MeleeFireClass=Class'BWBP_SKCExp_Pro.SawnOffMeleeFire'
     ...
     FireModeClass(0)=Class'BWBP_SKCExp_Pro.SawnOffPrimaryFire'
