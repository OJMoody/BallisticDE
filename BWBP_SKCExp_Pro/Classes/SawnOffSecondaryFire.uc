...
//=============================================================================
class SawnOffSecondaryFire extends BallisticProShotgunFire;
...
{
	BallisticAttachment(Weapon.ThirdPersonActor).BallisticUpdateHit(Other, HitLocation, HitNormal, Surf, SawnOffShotgun(Weapon).bRightLoaded, WaterHitLoc);
	//M290Attachment(Weapon.ThirdPersonActor).M290UpdateHit(Other, HitLocation, HitNormal, Surf, !SawnOffShotgun(Weapon).bRightLoaded);
}
