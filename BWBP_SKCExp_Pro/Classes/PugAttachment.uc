...
defaultproperties
{
     AltBrassClass1=Class'BWBP_SKCExp_Pro.Brass_FRAGSpent'
     AltBrassClass2=Class'BWBP_SKCExp_Pro.Brass_FRAG'
     ...
     BrassClass=Class'BWBP_SKCExp_Pro.Brass_BOLT'
     BrassMode=MU_Both
     FlashMode=MU_Both
     ...
     Mesh=SkeletalMesh'BWBP_SKC_AnimExp.Pug_TPm'
