...
{
	if (LaserDot == None)
		LaserDot = Spawn(class'BWBP_SKCExp_Pro.TAC30LaserDot',,,Loc);
}
...
defaultproperties
{
	 ...
	 GunLength=32.000000
     FireModeClass(0)=Class'BWBP_SKCExp_Pro.TAC30PrimaryFire'
     FireModeClass(1)=Class'BWBP_SKCExp_Pro.TAC30SecondaryFire'
     AIRating=0.600000
     ...
     InventoryGroup=6
     PickupClass=Class'BWBP_SKCExp_Pro.TAC30Pickup'
     PlayerViewOffset=(X=-4.000000,Y=8.000000,Z=-11.000000)
     BobDamping=1.700000
     AttachmentClass=Class'BWBP_SKCExp_Pro.TAC30Attachment'
     ...
     Mesh=SkeletalMesh'BWBP_SKC_AnimExp.FPm_TAC30'
     DrawScale=0.260000
	 ParamsClasses(0)=Class'TAC30CannonWeaponParamsArena'
	 ParamsClasses(1)=Class'TAC30CannonWeaponParamsArena'
}
