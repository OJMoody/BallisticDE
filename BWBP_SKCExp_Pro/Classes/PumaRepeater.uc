...
defaultproperties
{
     ...
     GunLength=48.000000
     FireModeClass(0)=Class'BWBP_SKCExp_Pro.PumaPrimaryFire'
     FireModeClass(1)=Class'BWBP_SKCExp_Pro.PumaSecondaryFire'
     ...
     InventoryGroup=8
     PickupClass=Class'BWBP_SKCExp_Pro.PumaPickup'
     PlayerViewOffset=(X=-4.000000,Y=6.000000,Z=-11.000000)
     AttachmentClass=Class'BWBP_SKCExp_Pro.PumaAttachment'
