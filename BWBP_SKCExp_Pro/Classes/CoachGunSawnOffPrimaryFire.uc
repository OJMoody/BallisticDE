...
//=============================================================================
class CoachGunSawnOffPrimaryFire extends BallisticProShotgunFire;
...
{
	CoachGunSawnOffAttachment(Weapon.ThirdPersonActor).SwitchWeaponMode(newMode);
...
{
	if (CoachGunSawnOff(BW).BCRepClass.default.GameStyle != 0)
	{
		super.ModeDoFire();
		return;
	}
