...
defaultproperties
{
     ...
     ImpactDamage=70
     ImpactDamageType=Class'BWBP_SKCExp_Pro.DT_PUMAGrenade'
     ImpactManager=Class'BWBP_SKCExp_Pro.IM_PumaDet'
     TrailClass=Class'BWBP_SKCExp_Pro.PumaProjectileFastTrail'
     MyRadiusDamageType=Class'BWBP_SKCExp_Pro.DT_PUMARadius'
     ...
     MyDamageType=Class'BWBP_SKCExp_Pro.DT_PUMAGrenade'
     LightHue=180
     LightSaturation=100
