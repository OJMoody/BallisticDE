...
defaultproperties
{
     ...
     MuzzleFlashClass=Class'BWBPAnotherPackDE.FMPFlashEmitter'
	 ImpactManager=Class'BallisticDE.IM_Bullet'
     
	 MuzzleFlashClassRed=Class'BWBPAnotherPackDE.SRXFlashEmitter'
     MuzzleFlashClassGreen=Class'BallisticDE.A500FlashEmitter'
	 
	 TracerClass=Class'BWBPRecolorsDE.TraceEmitter_MARS'
     TracerClassRed=Class'BWBPRecolorsDE.TraceEmitter_HMG'
     TracerClassGreen=Class'BWBPRecolorsDE.TraceEmitter_Tranq'
	 
     ImpactManagerRed=Class'BWBPAnotherPackDE.IM_BulletHE'
     ImpactManagerGreen=Class'BWBPAnotherPackDE.IM_BulletAcid'
