...
defaultproperties
{
     ...
     AltMuzzleFlashClass=Class'BWBPAnotherPackDE.MG36SilencedFlash'
     ...
     FlashMode=MU_Both
     LightMode=MU_Both
     TracerClass=Class'BWBPAnotherPackDE.TraceEmitter_MG36'
	 ...
	 FlashScale=0.500000
     Mesh=SkeletalMesh'BWBPAnotherPackAnims.MG36_TPm'
