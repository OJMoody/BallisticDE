...
defaultproperties
{
     HitEffects(0)=Class'BWBPAnotherPackDE.IE_BulletHE'
     HitEffects(1)=Class'BWBPAnotherPackDE.IE_BulletHE'
     HitEffects(2)=Class'BWBPAnotherPackDE.IE_BulletHE'
     HitEffects(3)=Class'BWBPAnotherPackDE.IE_BulletHE'
     HitEffects(4)=Class'BWBPAnotherPackDE.IE_BulletHE'
     HitEffects(5)=Class'BWBPAnotherPackDE.IE_BulletHE'
     HitEffects(6)=Class'BWBPAnotherPackDE.IE_BulletHE'
     HitEffects(7)=Class'BWBPAnotherPackDE.IE_BulletHE'
     HitEffects(8)=Class'BWBPAnotherPackDE.IE_BulletHE'
