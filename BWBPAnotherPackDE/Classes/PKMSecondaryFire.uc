...
// Ballistic knife.
//=============================================================================
class PKMSecondaryFire extends BallisticProjectileFire;
...
simulated function bool CheckKnife()
{
	...
	if (!bLoaded)
	{
		...
		if (seq == PKMMachinegun(Weapon).KnifeLoadAnim)
			return false;
		PKMMachinegun(Weapon).LoadKnife();
		bIsFiring=false;
		return false;
	}
	return true;
...
defaultproperties
{
     ...
     FireRate=0.650000
     AmmoClass=Class'BallisticDE.Ammo_XMK5Darts'
     ShakeRotTime=2.000000
     ShakeOffsetMag=(X=-20.000000)
     ShakeOffsetRate=(X=-1000.000000)
     ShakeOffsetTime=2.000000
     ProjectileClass=Class'BWBPAnotherPackDE.PKMKnife'
