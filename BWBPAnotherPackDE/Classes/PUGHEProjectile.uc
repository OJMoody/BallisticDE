...
//=============================================================================
class PUGHEProjectile extends BallisticGrenade;
...
defaultproperties
{
     ...
     ImpactDamage=55
     ImpactDamageType=Class'BWBPAnotherPackDE.DTBulldog'
     ImpactManager=Class'BWBPRecolorsDE.IM_SlugHE'
     AccelSpeed=3000.000000
     TrailClass=Class'BWBPAnotherPackDE.PUGFireTrail'
     TrailOffset=(X=-8.000000)
     MyRadiusDamageType=Class'BWBPAnotherPackDE.DTBulldog'
     ...
     MyDamageType=Class'BWBPAnotherPackDE.DTBulldog'
     LightHue=180
     LightSaturation=100
