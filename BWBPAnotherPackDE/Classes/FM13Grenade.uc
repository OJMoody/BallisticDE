...
defaultproperties
{
     ...
     ImpactManager=Class'BWBPAnotherPackDE.IM_FM13Grenade'
     TrailClass=Class'BallisticDE.M50GrenadeTrail'
     TrailOffset=(X=-8.000000)
     MyRadiusDamageType=Class'BallisticDE.DTM50GrenadeRadius'
     ...
     MyDamageType=Class'BallisticDE.DTM50GrenadeRadius'
