...
//=============================================================================
class GRSXXSecondaryFire extends BallisticRangeAttenFire;
...
defaultproperties
{
     ...
     DamageType=Class'BWBPAnotherPackDE.DTGRSXXLaser'
     DamageTypeHead=Class'BWBPAnotherPackDE.DTGRSXXLaserHead'
     DamageTypeArm=Class'BWBPAnotherPackDE.DTGRSXXLaser'
     PenetrateForce=200
     bPenetrate=True
     bUseWeaponMag=False
     FlashBone="tip2"
