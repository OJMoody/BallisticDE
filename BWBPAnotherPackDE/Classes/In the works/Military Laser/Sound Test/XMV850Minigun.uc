...
defaultproperties
{
     ...
     BarrelSpinSound=Sound'BWBPAnotherPackSounds2.MillitaryLaser.XR4-Laser'
     BarrelStopSound=Sound'BWBPAnotherPackSounds2.MillitaryLaser.XR4-LaserOff'
     BarrelStartSound=Sound'BWBPAnotherPackSounds2.MillitaryLaser.XR4-LaserOn'
     ...
     FireModeClass(0)=Class'BWBPAnotherPackDE.XMV850MinigunPrimaryFire'
     FireModeClass(1)=Class'BallisticDE.XMV850MinigunSecondaryFire'
     ...
     InventoryGroup=6
     GroupOffset=2
     PickupClass=Class'BallisticDE.XMV850Pickup'
     PlayerViewOffset=(X=11.000000,Y=8.000000,Z=-14.000000)
     AttachmentClass=Class'BallisticDE.XMV850MinigunAttachment'
     IconMaterial=Texture'BallisticUI2.Icons.SmallIcon_XMV850'
     IconCoords=(X2=127,Y2=31)
     ItemName="TestMinigun"
     LightType=LT_Pulse
