...
defaultproperties
{
     ...
     DamageType=Class'BallisticDE.DTXMV850MG'
     DamageTypeHead=Class'BallisticDE.DTXMV850MGHead'
     DamageTypeArm=Class'BallisticDE.DTXMV850MG'
     KickForce=1000
     PenetrateForce=150
     bPenetrate=True
     MuzzleFlashClass=Class'BallisticDE.XMV850FlashEmitter'
     ...
     BallisticFireSound=(Sound=Sound'BWBPAnotherPackSounds2.MillitaryLaser.LaserPrimary',Slot=SLOT_Interact,bNoOverride=False)
     bPawnRapidFireAnim=True
     FireRate=0.050000
     AmmoClass=Class'BallisticDE.Ammo_MinigunRounds'
