...
simulated function float ChargeBar()
{
	if (FireMode[1].bIsFiring)
		return FMin(1, FireMode[1].HoldTime / BarrierPrimaryFire(FireMode[1]).ChargeTime);
	return FMin(1, BarrierPrimaryFire(FireMode[1]).DecayCharge / BarrierPrimaryFire(FireMode[1]).ChargeTime);
}
...
defaultproperties
{
     ...
     FireModeClass(1)=Class'BWBPAnotherPackDE.BarrierPrimaryFire'
