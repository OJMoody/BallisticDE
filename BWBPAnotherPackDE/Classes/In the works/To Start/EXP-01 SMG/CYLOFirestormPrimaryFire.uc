...
defaultproperties
{
     ...
     DamageType=Class'BWBPAnotherPackDE.DTCYLOFirestormRifle'
     DamageTypeHead=Class'BWBPAnotherPackDE.DTCYLOFirestormRifleHead'
     DamageTypeArm=Class'BWBPAnotherPackDE.DTCYLOFirestormRifle'
     KickForce=6000
     PenetrateForce=180
     ...
     MuzzleFlashClass=Class'BWBPAnotherPackDE.CYLOFirestormHeatEmitter'
     FlashBone="Muzzle"
