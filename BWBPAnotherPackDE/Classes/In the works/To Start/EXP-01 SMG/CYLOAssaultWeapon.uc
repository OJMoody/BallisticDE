...
defaultproperties
{
     ...
     SightOffset=(X=1.000000,Y=-0.300000,Z=13.200000)
	 PlayerViewOffset=(X=10.000000,Y=4.000000,Z=-8.000000)
     ...
     FireModeClass(0)=Class'BWBPAnotherPackDE.CYLOFirestormPrimaryFire'
     FireModeClass(1)=Class'BWBPAnotherPackDE.RS04SecondaryFire'
	 ...
	 AIRating=0.7
	 CurrentRating=0.7
     PickupClass=Class'BWBPAnotherPackDE.CYLOFirestormPickup'
     AttachmentClass=Class'BWBPAnotherPackDE.CYLOFirestormAttachment'
     IconMaterial=Texture'BallisticRecolors3TexPro.CYLO.SmallIcon_CYLOMk2'
     ItemName="EXP-01 Cougar Bullpup"
     Mesh=SkeletalMesh'BWBPAnotherPackAnims.FPm_Bullpup'
}
