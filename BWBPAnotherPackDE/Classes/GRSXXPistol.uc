...
defaultproperties
{
	...
	FireModeClass(0)=Class'BWBPAnotherPackDE.GRSXXPrimaryFire'
	FireModeClass(1)=Class'BWBPAnotherPackDE.GRSXXSecondaryFire'
	...
	InventoryGroup=3
	GroupOffset=3
	PickupClass=Class'BWBPAnotherPackDE.GRSXXPickup'
	PlayerViewOffset=(X=6.000000,Y=8.000000,Z=-9.000000)
	AttachmentClass=Class'BWBPAnotherPackDE.GRSXXAttachment'
