class M575TW_PrimaryFire extends M575PrimaryFire;
...
{
	if (Weapon.IsInState('PendingClientWeaponSet'))
		return false;
...
defaultproperties
{
     DamageType=Class'BWBPAnotherPackDE.DTM575MGDeploy'
     DamageTypeHead=Class'BWBPAnotherPackDE.DTM575MGDeployHead'
     DamageTypeArm=Class'BWBPAnotherPackDE.DTM575MGDeploy'
