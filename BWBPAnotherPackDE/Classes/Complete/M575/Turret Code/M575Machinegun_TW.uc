...
// M575Machinegun_TW.
//
// Weapon used for M575 Turrets. Properties altered to be more like a deployed wepaon
//
// by Nolan "Dark Carnivour" Richert.
// Copyright(c) 2006 RuneStorm. All Rights Reserved.
//=============================================================================
class M575Machinegun_TW extends BallisticMachinegun
    HideDropDown
	CacheExempt;
...
defaultproperties
{
     ...
     FireModeClass(0)=Class'BWBPAnotherPackDE.M575TW_PrimaryFire'
     ...
     Description="M575 MachineGun||Manufacturer: Enravion Combat Solutions|Primary: Very fast inaccurate fire|Secondary: Mount Machinegun||The M575 'Guardian' Machinegun, has seen some of the most brutal battles ever recorded in recent history, and has helped win many of them, the most famous being the bloody 'Wasteland Seige' where 12 million Krao were slaughtered along a 500 mile line of defences. Used primarily as a defensive weapon, the M575's incredible rate of fire can quickly and effectively destroy masses of oncoming foes, especially melee attackers. When the secondary mode is activated, the Guardian, becomes much more accurate when the user mounts it on the ground, allowing it to be a very effective defensive weapon. With it's high rate of fire and high damage, the M575 becomes very inaccurate after just a few rounds and with its high ammo capacity, comes the difficulty of longer reload times than smaller weapons."
     ...
     ItemName="M575 Machinegun Turret"
     LightType=LT_Pulse
     ...
     Mesh=SkeletalMesh'BWBPAnotherPackAnims.FPm_Turret_M575'
     DrawScale=1.000000
