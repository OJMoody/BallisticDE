...
//=============================================================================
class MG36Rifle extends BallisticWeapon;
...
function Notify_Deploy()
{
    ...
    if (Turret != None)
    {
		...
		log("Notify_Deploy: Could not spawn turret for MG36 Rifle");
}
...
defaultproperties
{
	AimDisplacementDurationMult=1.25
     ...
     bCockOnEmpty=True
     WeaponModes(0)=(ModeName="Full Auto")
     ...
     ChaosAimSpread=3072
     RecoilXFactor=0.020000
     RecoilYFactor=0.020000
     ...
     InventoryGroup=6
     PickupClass=Class'BWBPAnotherPackDE.MG36Pickup'
