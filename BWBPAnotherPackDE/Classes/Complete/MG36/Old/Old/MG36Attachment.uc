...
// MG36Attachment.
//
// 3rd person weapon attachment for MG36 Sniper Rifle
//
...
simulated function Vector GetTipLocation()
{
	...
	{
		if (MG36Rifle(Instigator.Weapon).bScopeView)
		{
...
defaultproperties
{
     MuzzleFlashClass=Class'BallisticDE.R78FlashEmitter'
     ImpactManager=Class'BWBPAnotherPackDE.IM_ExpBullet'
     BrassClass=Class'BWBPAnotherPackDE.Brass_BMG'
     TracerClass=Class'BWBPAnotherPackDE.TraceEmitter_HMG'
     WaterTracerClass=Class'BallisticDE.TraceEmitter_WaterBullet'
     WaterTracerMode=MU_Both
     FlyBySound=(Sound=Sound'PackageSounds4Pro.MG36.X83-FlyBy',Volume=2.500000)
