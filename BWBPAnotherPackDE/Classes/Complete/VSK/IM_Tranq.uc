...
defaultproperties
{
     ...
     HitSounds(0)=Sound'BWBPAnotherPackSounds.VSK.VSK-Impact'
     HitSounds(1)=Sound'BWBPAnotherPackSounds.VSK.VSK-Impact'
     HitSounds(2)=Sound'BWBPAnotherPackSounds.VSK.VSK-Impact'
     HitSounds(3)=Sound'BWBPAnotherPackSounds.VSK.VSK-Impact'
     HitSounds(4)=Sound'BWBPAnotherPackSounds.VSK.VSK-Impact'
     HitSounds(5)=Sound'BWBPAnotherPackSounds.VSK.VSK-Impact'
     HitSounds(6)=Sound'BWBPAnotherPackSounds.VSK.VSK-Impact'
     HitSounds(7)=Sound'BWBPAnotherPackSounds.VSK.VSK-Impact'
     HitSounds(8)=Sound'BWBPAnotherPackSounds.VSK.VSK-Impact'
     HitSounds(9)=SoundGroup'BallisticSounds2.BulletImpacts.BulletWater'
     HitSounds(10)=Sound'BWBPAnotherPackSounds.VSK.VSK-Impact'
