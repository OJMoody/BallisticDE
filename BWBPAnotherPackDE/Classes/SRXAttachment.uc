...
defaultproperties
{
     ...
     MuzzleFlashClassAmp1=Class'BWBPAnotherPackDE.SRXFlashEmitter'
     MuzzleFlashClassAmp2=Class'BallisticDE.A500FlashEmitter'
	 
     ImpactManagerAmp1=Class'BWBPAnotherPackDE.IM_BulletHE'
     ImpactManagerAmp2=Class'BWBPAnotherPackDE.IM_BulletAcid'
	 
	 TracerClassAmp1=Class'BWBPRecolorsDE.TraceEmitter_HMG'
     TracerClassAmp2=Class'BWBPRecolorsDE.TraceEmitter_Tranq'
	 
	 MuzzleFlashClass=Class'BallisticDE.M50FlashEmitter'
     AltMuzzleFlashClass=Class'BWBPAnotherPackDE.SRXSilencedFlash'
     AltFlashBone="tip2"
