...
defaultproperties
{
     ...
     TraceCount=10
     TracerClass=Class'BWBPAnotherPackDE.TraceEmitter_ShotgunFlame'
     ImpactManager=Class'BWBPAnotherPackDE.IM_FireShot'
     TraceRange=(Min=3072.000000,Max=3072.000000)
     Damage=10.000000

     RangeAtten=0.15000
     DamageType=Class'BWBPAnotherPackDE.DTFM13Shotgun'
     DamageTypeHead=Class'BWBPAnotherPackDE.DTFM13ShotgunHead'
     DamageTypeArm=Class'BWBPAnotherPackDE.DTFM13Shotgun'
     KickForce=5000
     PenetrateForce=0
	 bPenetrate=False
	 WallPenetrationForce=0
     MuzzleFlashClass=Class'BWBPAnotherPackDE.FM13FlashEmitter'
     ...
     FireAnimRate=0.9
     FireRate=0.85
     AmmoClass=Class'BWBPAnotherPackDE.Ammo_FM13IncendiaryGauge'
