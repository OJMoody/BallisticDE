...
function PlayFiring()
{
	...
	if (LightMuzzleFlash == None || LightMuzzleFlash.bDeleteMe)
		class'BUtil'.static.InitMuzzleFlash (LightMuzzleFlash, class'BWBPAnotherPackDE.ParticleFlashEmitter', Weapon.DrawScale*FlashScaleFactor, weapon, FlashBone);
...
defaultproperties
{
     ...
     FireAnim="FireLoop"
     FireRate=0.070000
     AmmoClass=Class'BWBPOtherPackDE.Ammo_ProtonCharge'
