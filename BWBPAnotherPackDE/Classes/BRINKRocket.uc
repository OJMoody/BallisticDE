...
function ApplySlowdown(pawn Other, float Damage)
{
	...
	if (Slow == None)
	{
		Other.CreateInventory("BallisticDE.Inv_Slowdown");
		Slow = Inv_Slowdown(Other.FindInventoryType(class'Inv_Slowdown'));
	}
...
defaultproperties
{
     ...
     TrailClass=Class'BallisticDE.MRLTrailEmitter'
     TrailOffset=(X=-4.000000)
     MyRadiusDamageType=Class'BWBPAnotherPackDE.DTBRINKGrenade'
     ImpactManager=Class'BWBPAnotherPackDE.IM_BRINKGrenade'
     ...
     MyDamageType=Class'BWBPAnotherPackDE.DTBRINKGrenade'
