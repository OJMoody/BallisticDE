...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JunkWarHardware.Junk.RollingPinLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Rolling Pin"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JunkWarHardware.Junk.RollingPin'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'JunkWarDE.IM_JunkRollingPin'
         HookStopFactor=1.000000
         Damage=(head=90,Limb=17,Misc=37)
         KickForce=7000
         DamageType=Class'JunkWarDE.DTJunkRollingPin'
         RefireTime=0.600000
         AnimRate=1.200000
         Sound=(Sound=SoundGroup'JunkWarSounds.Crowbar.Crowbar-Swing',Pitch=0.850000)
         Anims(0)="AvgHit1"
         Anims(1)="AvgHit2"
         Anims(2)="AvgHit3"
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_RollingPin.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         RefireTime=0.800000
         AnimRate=1.250000
         Sound=(Sound=SoundGroup'JunkWarSounds.Crowbar.Crowbar-Swing',Pitch=0.800000)
         Anims(0)="WideAttack"
         PreFireAnims(0)="WidePrepAttack"
         bFireOnRelease=True
         AnimTimedFire=ATS_Early
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_RollingPin.JunkFireInfo1'
     ...
     PainThreshold=35
     NoUseThreshold=65
     StaticMesh=StaticMesh'JunkWarHardware.Junk.RollingPin'
     DrawScale=1.650000
}
