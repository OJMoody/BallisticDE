...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JunkWarHardware.Junk.WineGlassLD'
     PickupDrawScale=0.400000
     PickupMessage="You aquired the Wine Glass, ahem"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JunkWarHardware.Junk.WineGlass'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'JunkWarDE.IM_JunkGlassSmallBreak'
         DestroyOn=BT_HitAnything
         Damage=(head=45,Limb=15,Misc=27)
         KickForce=2000
         DamageType=Class'JunkWarDE.DTJunkWineGlass'
         RefireTime=0.400000
         AnimRate=1.200000
         Sound=(Sound=SoundGroup'JunkWarSounds.Spanner.Spanner-Swing',Pitch=0.900000)
         Anims(0)="AvgHit1"
         Anims(1)="AvgHit2"
         Anims(2)="AvgHit3"
         AnimTimedFire=ATS_Timed
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_WineGlass.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_WineGlass.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1800
         ProjMass=10
         ProjMesh=StaticMesh'JunkWarHardware.Junk.WineGlass'
         ProjScale=0.250000
         SpinRates=(Pitch=40000)
         ExplodeManager=Class'JunkWarDE.IM_JunkGlassSmallBreak'
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'JunkWarDE.JO_WineGlass.JunkThrowFireInfo0'
     ...
     PainThreshold=5
     NoUseThreshold=10
     StaticMesh=StaticMesh'JunkWarHardware.Junk.WineGlass'
}
