...
defaultproperties
{
     PickupMesh=StaticMesh'JunkWarHardware.Junk.WheelSpannerLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Wheel Spanner"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JunkWarHardware.Junk.WheelSpanner'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'JunkWarDE.IM_JunkWheelSpanner'
         Damage=(head=85,Limb=15,Misc=32)
         KickForce=5000
         DamageType=Class'JunkWarDE.DTJunkWheelSpanner'
         RefireTime=0.500000
         AnimRate=1.500000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_WheelSpanner.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_WheelSpanner.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1500
         ProjMass=20
         ProjMesh=StaticMesh'JunkWarHardware.Junk.WheelSpannerLD'
         ProjScale=0.250000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'JunkWarDE.JO_WheelSpanner.JunkThrowFireInfo0'
     ...
     PainThreshold=40
     NoUseThreshold=80
     StaticMesh=StaticMesh'JunkWarHardware.Junk.WheelSpanner'
     DrawScale=1.250000
}
