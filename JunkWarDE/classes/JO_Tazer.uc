...
defaultproperties
{
     PickupMesh=StaticMesh'JunkWarHardware.Junk.TazerLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Tazer, zapping time"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JunkWarHardware.Junk.Tazer'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=90000
         DamageType=Class'JunkWarDE.DTJunkTazer'
         RefireTime=0.400000
         AnimRate=1.500000
         Sound=(Sound=SoundGroup'JunkWarSounds.Misc.Electro-Swing',Volume=0.600000)
         Anims(0)="AvgHit1"
         Anims(1)="StabHit1"
         Anims(2)="AvgHit2"
         Anims(3)="StabHit2"
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_Tazer.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_Tazer.JunkFireInfo1'

     SelectSound=(Sound=Sound'JunkWarSounds.Misc.Pullout-Electro')
     FriendlyName="Tazer"
     InventoryGroup=6
     ...
     PainThreshold=25
     NoUseThreshold=50
     StaticMesh=StaticMesh'JunkWarHardware.Junk.Tazer'
}
