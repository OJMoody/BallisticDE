...
//=============================================================================
class IE_BigMetal extends DGVEmitter
	placeable;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter0
         ...
         ColorMultiplierRange=(X=(Min=0.900000),Y=(Min=0.700000,Max=0.900000),Z=(Min=0.600000,Max=0.700000))
         Opacity=0.160000
         ...
         Texture=Texture'JunkWarSkins.Effects.Smoke4'
         SecondsBeforeInactive=0.000000
         LifetimeRange=(Min=2.000000,Max=2.000000)
         StartVelocityRange=(X=(Min=5.000000,Max=25.000000),Y=(Min=-10.000000,Max=10.000000),Z=(Min=-10.000000,Max=10.000000))
     End Object
     Emitters(0)=SpriteEmitter'JunkWarDE.IE_BigMetal.SpriteEmitter0'
     ...
     Begin Object Class=SparkEmitter Name=SparkEmitter0
         ...
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=255,G=255,R=255,A=255))
         ColorMultiplierRange=(Y=(Min=0.800000),Z=(Min=0.500000,Max=0.600000))
         Opacity=0.850000
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1
         ...
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=255,G=255,R=255,A=255))
         ColorMultiplierRange=(Y=(Min=0.800000),Z=(Min=0.500000,Max=0.700000))
         Opacity=0.350000
         ...
         Texture=Texture'JunkWarSkins.Effects.FlareB1'
         SecondsBeforeInactive=0.000000
         LifetimeRange=(Min=1.000000,Max=1.000000)
     End Object
     Emitters(2)=SpriteEmitter'JunkWarDE.IE_BigMetal.SpriteEmitter1'
