...
defaultproperties
{
     ...
     HitSounds(0)=SoundGroup'JunkWarSounds.Conpole.Conpole-Concrete'
     HitSounds(1)=SoundGroup'JunkWarSounds.Conpole.Conpole-Concrete'
     HitSounds(2)=SoundGroup'JunkWarSounds.Conpole.Conpole-Dirt'
     HitSounds(3)=SoundGroup'JunkWarSounds.Conpole.Conpole-Metal'
     ...
     HitSounds(10)=SoundGroup'JunkWarSounds.Conpole.Conpole-Concrete'
