...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JunkWarHardware.Junk.IcePickLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Ice Pick"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JunkWarHardware.Junk.Icepick'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'JunkWarDE.IM_JunkIcePick'
         HookStopFactor=1.200000
         HookPullForce=100.000000
         Damage=(head=87,Limb=15,Misc=32)
         KickForce=5000
         DamageType=Class'JunkWarDE.DTJunkIcePick'
         RefireTime=0.400000
         AnimRate=1.500000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_IcePick.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_IcePick.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1500
         ProjMass=20
         ProjMesh=StaticMesh'JunkWarHardware.Junk.IcePickLD'
         ProjScale=0.400000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'JunkWarDE.JO_IcePick.JunkThrowFireInfo0'
     ...
     PainThreshold=35
     NoUseThreshold=60
     StaticMesh=StaticMesh'JunkWarHardware.Junk.Icepick'
     DrawScale=1.400000
}
