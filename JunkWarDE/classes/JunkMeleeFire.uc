...
simulated function AssignHitInfo(JunkMeleeFireInfo NewFire)
{
	...
	DamageHead 		= NewFire.Damage.Head;
	DamageLimb	 	= NewFire.Damage.Limb;
...
defaultproperties
{
     ...
     DamageType=Class'JunkWarDE.DTJunkDamage'
     bReleaseFireOnDie=False
     BallisticFireSound=(Sound=SoundGroup'JunkWarSounds.Pipe.Pipe-Swing',Radius=32.000000,bAtten=True)
     bAISilent=True
     PreFireAnim="PrepHit"
     FireAnim="Hit1"
     AmmoClass=Class'JunkWarDE.Ammo_JunkWarAmmo'
     AmmoPerFire=0
