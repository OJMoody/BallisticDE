...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JunkWarHardware.Junk.SpannerLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Spanner"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JunkWarHardware.Junk.Spanner'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=2000
         DamageType=Class'JunkWarDE.DTJunkSpanner'
         RefireTime=0.350000
         AnimRate=1.500000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_Spanner.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_Spanner.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1500
         ProjMass=20
         ProjMesh=StaticMesh'JunkWarHardware.Junk.SpannerLD'
         ProjScale=0.250000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'JunkWarDE.JO_Spanner.JunkThrowFireInfo0'
     ...
     PainThreshold=15
     NoUseThreshold=25
     StaticMesh=StaticMesh'JunkWarHardware.Junk.Spanner'
     DrawScale=1.400000
}
