...
//							FI.BounceImpactManager;
		...
		DamageHead	=	FI.Damage.Head;
		DamageLimb	=	FI.Damage.Limb;
...
defaultproperties
{
     ...
     SplashManager=Class'JunkWarDE.IM_JunkPipeCorner'
     ShakeRadius=0.000000
     bWarnEnemy=False
     Speed=2000.000000
     Damage=20.000000
     MomentumTransfer=10000.000000
     StaticMesh=StaticMesh'JunkWarHardware.Junk.PipeCornerLD'
     bNetTemporary=False
     AmbientGlow=32
     bUnlit=False
     bNetNotify=True
