...
//=============================================================================
class Mut_JunkWar extends Mutator config(JunkWarDE);
...
function PostBeginPlay()
{
	...
	if (bNoOtherWeapons)
		DefaultWeaponName = "JunkWarDE.JunkWeapon";
...
function bool CheckReplacement(Actor Other, out byte bSuperRelevant)
{
	...
	if (bNoOtherWeapons)
	{
		if (xPawn(Other) != None)
		{
			xPawn(Other).RequiredEquipment[0] = "JunkWarDE.JunkWeapon";
...
defaultproperties
{
     ...
     ConfigMenuClassName="JunkWarDE.JunkWarConfigMenu"
