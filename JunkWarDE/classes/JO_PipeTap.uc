...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JunkWarHardware.Junk.PipeTapLD'
     PickupDrawScale=0.400000
     SpawnPivot=(Roll=-16384)
     PickupPrePivot=(Y=16.000000)
     PickupMessage="You got the Pipe and Tap"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JunkWarHardware.Junk.PipeTap'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'JunkWarDE.IM_JunkPipeTap'
         HookStopFactor=1.200000
         HookPullForce=50.000000
         Damage=(head=100,Limb=20,Misc=37)
         KickForce=5000
         DamageType=Class'JunkWarDE.DTJunkPipeTap'
         RefireTime=0.600000
         AnimRate=1.250000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_PipeTap.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_PipeTap.JunkFireInfo1'
     ...
     StaticMesh=StaticMesh'JunkWarHardware.Junk.PipeTap'
}
