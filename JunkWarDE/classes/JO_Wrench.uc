...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JunkWarHardware.Junk.WrenchLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Wrench, plumb some heads off"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JunkWarHardware.Junk.Wrench'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=10000
         DamageType=Class'JunkWarDE.DTJunkWrench'
         RefireTime=0.600000
         AnimRate=1.200000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_Wrench.JunkFireInfo0'
     ...
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_Wrench.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1500
         ProjMass=20
         ProjMesh=StaticMesh'JunkWarHardware.Junk.WrenchLD'
         ProjScale=0.250000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'JunkWarDE.JO_Wrench.JunkThrowFireInfo0'
     ...
     PainThreshold=40
     NoUseThreshold=80
     StaticMesh=StaticMesh'JunkWarHardware.Junk.Wrench'
     DrawScale=1.200000
}
