...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JunkWarHardware.Junk.Truncheon'
     PickupDrawScale=0.400000
     PickupMessage="You got the Truncheon, find some protesters!"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JunkWarHardware.Junk.Truncheon'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'JunkWarDE.IM_JunkTruncheon'
         Damage=(head=85,Limb=15,Misc=27)
         KickForce=5000
         DamageType=Class'JunkWarDE.DTJunkTruncheon'
         RefireTime=0.450000
         AnimRate=1.600000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_Truncheon.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_Truncheon.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1500
         ProjMass=20
         ProjMesh=StaticMesh'JunkWarHardware.Junk.TruncheonLD'
         ProjScale=0.250000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'JunkWarDE.JO_Truncheon.JunkThrowFireInfo0'
     ...
     PainThreshold=45
     NoUseThreshold=85
     StaticMesh=StaticMesh'JunkWarHardware.Junk.Truncheon'
}
