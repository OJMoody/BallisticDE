...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JunkWarHardware.Junk.GearLeverLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Gear Lever, shame"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JunkWarHardware.Junk.GearLever'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=3000
         DamageType=Class'JunkWarDE.DTJunkGearLever'
         RefireTime=0.500000
         AnimRate=1.500000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_GearLever.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_GearLever.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1500
         ProjMass=20
         ProjMesh=StaticMesh'JunkWarHardware.Junk.GearLeverLD'
         ProjScale=0.250000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'JunkWarDE.JO_GearLever.JunkThrowFireInfo0'
     ...
     PainThreshold=10
     NoUseThreshold=25
     StaticMesh=StaticMesh'JunkWarHardware.Junk.GearLever'
     DrawScale=1.250000
}
