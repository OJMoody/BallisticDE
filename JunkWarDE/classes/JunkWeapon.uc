...
//=============================================================================
class JunkWeapon extends BallisticWeapon config(JunkWarDE) HideDropDown CacheExempt;
...
simulated function PostBeginPlay()
{
	...
	Mat = Material(DynamicLoadObject("BallisticWeapons2.Hands.Hands-Shiny", class'Material'));
	if (Mat != None)
		Skins[0] = Mat;
	Mat = Material(DynamicLoadObject("BallisticWeapons2.Hands.RedHand-Shiny", class'Material'));
	if (Mat != None)
		TeamSkins[0].RedTex = Mat;
	Mat = Material(DynamicLoadObject("BallisticWeapons2.Hands.BlueHand-Shiny", class'Material'));
	if (Mat != None)
...
defaultproperties
{
     ...
     OneHandMesh=SkeletalMesh'JunkWarAnims.JunkHands'
     TwoHandMesh=SkeletalMesh'JunkWarAnims.DualJunkHands'
     TeamSkins(0)=(RedTex=Shader'JunkWarSkins.Hands.RedHandsShiny',BlueTex=Shader'JunkWarSkins.Hands.BlueHandsShiny')
     InventorySize=15
     BringUpSound=(Sound=SoundGroup'JunkWarSounds.Misc.Pullout-Small')
     MagAmmo=1
     bNoMag=True
     ...
     GunLength=0.000000
     bAimDisabled=True
     FireModeClass(0)=Class'JunkWarDE.JunkMeleeFire'
     FireModeClass(1)=Class'JunkWarDE.JunkRangedFire'
     IdleAnim="AvgIdle"
     ...
     CenteredRoll=0
     GroupOffset=5
     PickupClass=Class'JunkWarDE.JunkWeaponPickup'
     PlayerViewOffset=(X=-20.000000,Y=8.000000,Z=-14.000000)
     AttachmentClass=Class'JunkWarDE.JunkWeaponAttachment'
     IconMaterial=Texture'JunkWarSkins.ui.SmallIcon-PC'
     IconCoords=(X2=127,Y2=31)
     ItemName="Junk"
     Mesh=SkeletalMesh'JunkWarAnims.JunkHands'
     DrawScale=0.280000
}
