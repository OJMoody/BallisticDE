...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JunkWarHardware.Junk.ClawHammerLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Claw Hammer, go crack some heads."
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JunkWarHardware.Junk.ClawHammer'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'JunkWarDE.IM_JunkClawHammer'
         HookStopFactor=1.000000
         Damage=(head=85,Limb=15,Misc=27)
         KickForce=5000
         DamageType=Class'JunkWarDE.DTJunkClawHammer'
         RefireTime=0.450000
         AnimRate=1.500000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_ClawHammer.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_ClawHammer.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1500
         ProjMass=20
         ProjMesh=StaticMesh'JunkWarHardware.Junk.ClawHammerLD'
         ProjScale=0.250000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'JunkWarDE.JO_ClawHammer.JunkThrowFireInfo0'
     ...
     PainThreshold=35
     NoUseThreshold=60
     StaticMesh=StaticMesh'JunkWarHardware.Junk.ClawHammer'
     DrawScale=1.400000
}
