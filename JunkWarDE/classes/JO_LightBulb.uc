...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JunkWarHardware.Junk.LightBulbLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Light Bulb, now find something else!"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JunkWarHardware.Junk.LightBulb'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'JunkWarDE.IM_JunkLightBulb'
         DestroyOn=BT_HitAnything
         Damage=(head=40,Limb=10,Misc=22)
         KickForce=2000
         DamageType=Class'JunkWarDE.DTJunkLightBulb'
         RefireTime=0.400000
         AnimRate=1.200000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_LightBulb.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_LightBulb.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1800
         ProjMass=10
         ProjMesh=StaticMesh'JunkWarHardware.Junk.LightBulbLD'
         ProjScale=0.250000
         SpinRates=(Pitch=80000)
         ExplodeManager=Class'JunkWarDE.IM_JunkLightBulb'
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'JunkWarDE.JO_LightBulb.JunkThrowFireInfo0'
     ...
     PainThreshold=5
     NoUseThreshold=10
     StaticMesh=StaticMesh'JunkWarHardware.Junk.LightBulb'
}
