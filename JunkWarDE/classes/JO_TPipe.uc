...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JunkWarHardware.Junk.TPipeLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Junk Pipe"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JunkWarHardware.Junk.TPipe'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=6000
         DamageType=Class'JunkWarDE.DTJunkTPipe'
         RefireTime=0.450000
         AnimRate=1.600000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_TPipe.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_TPipe.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1500
         ProjMass=20
         ProjMesh=StaticMesh'JunkWarHardware.Junk.TPipeLD'
         ProjScale=0.250000
         WallImpactType=IT_Bounce
         ActorImpactType=IT_Bounce
         DampenFactor=0.150000
         SpinRates=(Pitch=650000)
         ImpactManager=Class'JunkWarDE.IM_PipeHitWall'
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'JunkWarDE.JO_TPipe.JunkThrowFireInfo0'
     ...
     PainThreshold=25
     NoUseThreshold=50
     StaticMesh=StaticMesh'JunkWarHardware.Junk.TPipe'
}
