...
defaultproperties
{
     PickupMesh=StaticMesh'JunkWarHardware.Junk.TireIronLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Tire Iron"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JunkWarHardware.Junk.TireIron'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'JunkWarDE.IM_JunkTyreIron'
         Damage=(head=82,Limb=15,Misc=32)
         KickForce=5000
         DamageType=Class'JunkWarDE.DTJunkTyreIron'
         RefireTime=0.500000
         AnimRate=1.500000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_TireIron.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_TireIron.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1500
         ProjMass=20
         ProjMesh=StaticMesh'JunkWarHardware.Junk.TireIronLD'
         ProjScale=0.250000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'JunkWarDE.JO_TireIron.JunkThrowFireInfo0'
     ...
     PainThreshold=20
     NoUseThreshold=40
     StaticMesh=StaticMesh'JunkWarHardware.Junk.TireIron'
     DrawScale=1.400000
}
