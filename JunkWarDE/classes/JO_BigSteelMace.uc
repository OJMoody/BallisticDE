...
// JO_BigSteelMace.
//
// Massive metal club with spikes.
//
// by Nolan "Dark Carnivour" Richert.
// Copyright(c) 2006 RuneStorm. All Rights Reserved.
//=============================================================================
class JO_BigSteelMace extends JunkObject;

defaultproperties
{
     HandOffset=(X=2.000000,Z=-6.000000)
     PickupMesh=StaticMesh'JunkWarHardware.Junk.MaceLD'
     PickupDrawScale=0.400000
     SpawnPivot=(Pitch=768)
     SpawnOffset=(Z=2.000000)
     PickupMessage="You got the Big Steel Mace."
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JunkWarHardware.Junk.Mace'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         MeleeRange=(Min=220.000000,Max=220.000000)
         SwipeHitWallPoint=6
         ...
         ImpactManager=Class'JunkWarDE.IM_JunkBigMace'
         HookStopFactor=1.600000
         Damage=(head=140,Limb=35,Misc=100)
         KickForce=25000
         DamageType=Class'JunkWarDE.DTJunkBigMace'
         RefireTime=1.100000
         AnimRate=1.400000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_BigSteelMace.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Early
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_BigSteelMace.JunkFireInfo1'

     SelectSound=(Sound=SoundGroup'JunkWarSounds.Misc.Pullout-Heavy')
     FriendlyName="Big Steel Mace"
     InventoryGroup=5
     ...
     StaticMesh=StaticMesh'JunkWarHardware.Junk.Mace'
     DrawScale=0.630000
}
