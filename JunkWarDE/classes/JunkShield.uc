...
//=============================================================================
class JunkShield extends Inventory config(JunkWarDE);
...
defaultproperties
{
     ...
     ShieldPropClass=Class'JunkWarDE.JunkShieldProp'
     ...
     MaxProtection=200
     bListed=True
     RedTeamSkin=Shader'JunkWarSkins.Hands.RedHandsShiny'
     BlueTeamSkin=Shader'JunkWarSkins.Hands.BlueHandsShiny'
     RenderedHand=1.000000
     PickupClass=Class'JunkWarDE.JunkShieldPickup'
     PlayerViewOffset=(X=-5.000000,Y=6.000000,Z=-18.000000)
     AttachmentClass=Class'JunkWarDE.JunkShieldAttachment'
     ItemName="Junk Shield"
     DrawType=DT_Mesh
     Mesh=SkeletalMesh'JunkWarAnims.JunkShieldHands'
     DrawScale=0.280000
     AmbientGlow=20
     MaxLights=6
     ScaleGlow=1.500000
