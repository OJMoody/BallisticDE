...
defaultproperties
{
     PickupMesh=StaticMesh'JunkWarHardware.Junk.CapacitorLD'
     PickupDrawScale=0.400000
     PickupMessage="You got an empty Capacitor"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JunkWarHardware.Junk.Capacitor'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'JunkWarDE.IM_JunkEmptyCapacitor'
         Damage=(head=75,Limb=12,Misc=30)
         KickForce=4000
         DamageType=Class'JunkWarDE.DTJunkEmptyCapacitor'
         RefireTime=0.600000
         AnimRate=1.000000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_EmptyCapacitor.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_EmptyCapacitor.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1800
         ProjMass=10
         ProjMesh=StaticMesh'JunkWarHardware.Junk.CapacitorLD'
         ProjScale=0.250000
         WallImpactType=IT_Bounce
         ActorImpactType=IT_Stick
         DampenFactor=0.150000
         SpinRates=(Pitch=80000)
         ExplodeManager=Class'JunkWarDE.IM_JunkEmptyCapacitor'
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'JunkWarDE.JO_EmptyCapacitor.JunkThrowFireInfo0'
     ...
     PainThreshold=16
     NoUseThreshold=34
     StaticMesh=StaticMesh'JunkWarHardware.Junk.Capacitor'
}
