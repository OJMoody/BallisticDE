...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JunkWarHardware.Junk.SteelRodLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Steel Rod"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JunkWarHardware.Junk.SteelRod'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'JunkWarDE.IM_JunkSteelRod'
         Damage=(head=75,Limb=15,Misc=32)
         KickForce=5000
         DamageType=Class'JunkWarDE.DTJunkSteelRod'
         RefireTime=0.400000
         AnimRate=1.750000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_SteelRod.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_SteelRod.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1500
         ProjMass=20
         ProjMesh=StaticMesh'JunkWarHardware.Junk.SteelRodLD'
         ProjScale=0.250000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'JunkWarDE.JO_SteelRod.JunkThrowFireInfo0'
     ...
     PainThreshold=20
     NoUseThreshold=35
     StaticMesh=StaticMesh'JunkWarHardware.Junk.SteelRod'
}
