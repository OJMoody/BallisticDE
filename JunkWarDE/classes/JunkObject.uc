...
//=============================================================================
class JunkObject extends Info config(JunkWarDE) exportstructs;
...
defaultproperties
{
     JunkActorClass=Class'JunkWarDE.JunkActor'
     HandFOV=60.000000
     HandScale=1.000000
     ...
     ThirdPersonActorClass=Class'JunkWarDE.JunkWeaponAttachment'
