...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JunkWarHardware.Junk.ConcretePoleLD'
     PickupDrawScale=0.400000
     SpawnPivot=(Pitch=768)
     SpawnOffset=(Z=2.000000)
     PickupMessage="You got the Concrete Pole. Smashing time!"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JunkWarHardware.Junk.ConcretePole'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=20000
         DamageType=Class'JunkWarDE.DTJunkConcretePole'
         RefireTime=1.250000
         AnimRate=1.500000
         Sound=(Sound=SoundGroup'JunkWarSounds.Conpole.Conpole-Swing')
         Anims(0)="Big2Hit1"
         Anims(1)="Big2Hit2"
         AnimTimedFire=ATS_Early
         bAnimTimedSound=True
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_ConcretePole.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Early
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_ConcretePole.JunkFireInfo1'
     ...
     StaticMesh=StaticMesh'JunkWarHardware.Junk.ConcretePole'
     DrawScale=0.600000
}
