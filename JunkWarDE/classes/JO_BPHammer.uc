...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JunkWarHardware.Junk.BPHammerLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Ball Peen Hammer."
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JunkWarHardware.Junk.BPHammer'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=6000
         DamageType=Class'JunkWarDE.DTJunkBPHammer'
         RefireTime=0.500000
         AnimRate=1.500000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_BPHammer.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_BPHammer.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1500
         ProjMass=20
         ProjMesh=StaticMesh'JunkWarHardware.Junk.BPHammerLD'
         ProjScale=0.250000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'JunkWarDE.JO_BPHammer.JunkThrowFireInfo0'
     ...
     PainThreshold=35
     NoUseThreshold=60
     StaticMesh=StaticMesh'JunkWarHardware.Junk.BPHammer'
     DrawScale=1.350000
}
