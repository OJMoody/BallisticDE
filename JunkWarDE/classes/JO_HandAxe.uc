...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JunkWarHardware.Junk.AxeLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Hand Axe"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JunkWarHardware.Junk.Axe'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'JunkWarDE.IM_JunkAxe'
         HookStopFactor=1.400000
         HookPullForce=80.000000
         Damage=(head=90,Limb=17,Misc=37)
         KickForce=7000
         DamageType=Class'JunkWarDE.DTJunkAxe'
         RefireTime=0.600000
         AnimRate=1.200000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_HandAxe.JunkFireInfo0'
     ...
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_HandAxe.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1500
         ProjMass=20
         ProjMesh=StaticMesh'JunkWarHardware.Junk.AxeLD'
         ProjScale=0.250000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'JunkWarDE.JO_HandAxe.JunkThrowFireInfo0'
     ...
     PainThreshold=36
     NoUseThreshold=65
     StaticMesh=StaticMesh'JunkWarHardware.Junk.Axe'
     DrawScale=1.500000
}
