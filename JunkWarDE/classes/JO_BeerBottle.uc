...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JunkWarHardware.Junk.BeerBottleLD'
     PickupDrawScale=0.300000
     PickupMessage="You got the Beer Bottles."
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JunkWarHardware.Junk.BeerBottle'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'JunkWarDE.IM_JunkBeerBottle'
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_BeerBottle.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_BeerBottle.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1800
         ProjMass=10
         ProjMesh=StaticMesh'JunkWarHardware.Junk.BeerBottleLD'
         ProjScale=0.250000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'JunkWarDE.JO_BeerBottle.JunkThrowFireInfo0'
     ...
     MorphedJunk=Class'JunkWarDE.JO_BeerBottleBroken'
     SpawnWeight=2.000000
     PainThreshold=10
     NoUseThreshold=25
     StaticMesh=StaticMesh'JunkWarHardware.Junk.BeerBottle'
}
