...
defaultproperties
{
     PickupMesh=StaticMesh'JunkWarHardware.Junk.WoodenStickLD'
     PickupDrawScale=0.400000
     SpawnPivot=(Pitch=768)
     SpawnOffset=(Z=2.000000)
     PickupMessage="You got the Wooden Stick"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JunkWarHardware.Junk.WoodenStick'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'JunkWarDE.IM_JunkWoodenStick'
         HookStopFactor=0.800000
         Damage=(head=92,Limb=20,Misc=42)
         KickForce=12000
         DamageType=Class'JunkWarDE.DTJunkWoodenStick'
         RefireTime=0.750000
         AnimRate=1.200000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_WoodenStick.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_WoodenStick.JunkFireInfo1'
     ...
     StaticMesh=StaticMesh'JunkWarHardware.Junk.WoodenStick'
     DrawScale=0.570000
}
