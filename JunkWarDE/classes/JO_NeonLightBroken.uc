...
defaultproperties
{
     PickupMesh=StaticMesh'JunkWarHardware.Junk.NeonLightBrokenLD'
     PickupDrawScale=0.300000
     PickupMessage="You got the Broken Neon Light"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JunkWarHardware.Junk.NeonLightBroken'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'JunkWarDE.IM_JunkNeonBroken'
         HookStopFactor=1.200000
         HookPullForce=80.000000
         Damage=(head=82,Limb=17,Misc=32)
         KickForce=5000
         DamageType=Class'JunkWarDE.DTJunkNeonLightStab'
         RefireTime=0.300000
         AnimRate=1.500000
         Sound=(Sound=SoundGroup'JunkWarSounds.Pipe.Pipe-Swing')
         Anims(0)="StabHit1"
         Anims(1)="StabHit2"
         Anims(2)="StabHit3"
         AnimTimedFire=ATS_Timed
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_NeonLightBroken.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         SwipePoints(3)=(Weight=4,offset=(Yaw=-1000))
         SwipePoints(4)=(Weight=2,offset=(Yaw=2000))
         ImpactManager=Class'JunkWarDE.IM_JunkNeonBrokenSec'
         HookStopFactor=1.200000
         HookPullForce=80.000000
         Damage=(head=105,Limb=20,Misc=40)
         KickForce=10000
         DamageType=Class'JunkWarDE.DTJunkNeonLightStabSec'
         RefireTime=0.800000
         AnimRate=1.250000
         Sound=(Sound=SoundGroup'JunkWarSounds.Pipe.Pipe-Swing')
         Anims(0)="StabAttack"
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_NeonLightBroken.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=2000
         ProjMass=10
         ProjMesh=StaticMesh'JunkWarHardware.Junk.NeonLightBrokenLD'
         ProjScale=0.250000
         SpinRates=(Pitch=650000)
         ExplodeManager=Class'JunkWarDE.IM_JunkNeonLightBreak'
         Damage=(head=85,Limb=17,Misc=40)
         KickForce=12000
         DamageType=Class'JunkWarDE.DTJunkNeonLight'
         RefireTime=0.400000
         AnimRate=1.250000
         Sound=(Sound=SoundGroup'JunkWarSounds.Pipe.Pipe-Swing')
         Anims(0)="StabThrow"
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'JunkWarDE.JO_NeonLightBroken.JunkThrowFireInfo0'

     SelectSound=(Sound=Sound'JunkWarSounds.Misc.Pullout-Glass')
     ...
     PainThreshold=15
     NoUseThreshold=20
     StaticMesh=StaticMesh'JunkWarHardware.Junk.NeonLightBroken'
}
