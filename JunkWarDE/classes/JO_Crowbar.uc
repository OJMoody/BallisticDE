...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JunkWarHardware.Junk.CrowbarLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Crowbar."
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JunkWarHardware.Junk.Crowbar'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=7000
         DamageType=Class'JunkWarDE.DTJunkCrowbar'
         RefireTime=0.600000
         AnimRate=1.200000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_Crowbar.JunkFireInfo0'
     ...
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_Crowbar.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1200
         ProjMass=25
         ProjMesh=StaticMesh'JunkWarHardware.Junk.CrowbarLD'
         ProjScale=0.250000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'JunkWarDE.JO_Crowbar.JunkThrowFireInfo0'
     ...
     NoUseThreshold=80
     StaticMesh=StaticMesh'JunkWarHardware.Junk.Crowbar'
     DrawScale=1.160000
}
