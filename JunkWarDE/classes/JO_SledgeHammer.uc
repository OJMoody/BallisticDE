...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JunkWarHardware.Junk.SledgeHammerLD'
     PickupDrawScale=0.400000
     SpawnPivot=(Pitch=768)
     SpawnOffset=(Z=2.000000)
     PickupMessage="You got the Sledge Hammer"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JunkWarHardware.Junk.SledgeHammer'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'JunkWarDE.IM_JunkSledgeHammer'
         HookStopFactor=1.000000
         Damage=(head=130,Limb=35,Misc=95)
         KickForce=25000
         DamageType=Class'JunkWarDE.DTJunkSledgeHammer'
         RefireTime=1.100000
         AnimRate=1.400000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_SledgeHammer.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Early
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JunkWarDE.JO_SledgeHammer.JunkFireInfo1'
     ...
     StaticMesh=StaticMesh'JunkWarHardware.Junk.SledgeHammer'
     DrawScale=0.630000
}
