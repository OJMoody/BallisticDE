...
//=============================================================================
class HydraSwoopRocket extends HydraRocket;

var   vector	LastLoc;	// Place where target was last seen
var	  vector 	StartLoc, EndLoc;	// Starting location and desired end location of rocket (for multi rocket "swooping" behaviour)
var   float		LaunchTime;			// Time of launch.
