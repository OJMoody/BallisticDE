...
//=============================================================================
class ThorAttachment extends BallisticAttachment;
...
var ThorLightningGun	LG;							// Access to the lightning gun itself (only available to owner)
...
function StartStream()
{
	...
	if (StreamEffect == None)
	{
		...
		if (ThorLightningGun(Instigator.Weapon) != None)
			ThorLightningGun(Instigator.Weapon).StreamEffect = StreamEffect;
...
{
	Super.InitFor(I);
	if (I != None && ThorLightningGun(I) != None)
		LG = ThorLightningGun(I);
}
...
simulated function InstantFireEffects(byte Mode)
{
	...
	if (Mode == 0 && ThorLightningGun(Instigator.Weapon).BCRepClass.default.GameStyle == 1)
		return;
...
simulated function Tick(float DT)
{
	...
	if (ThorLightningGun(Instigator.Weapon).BCRepClass.default.GameStyle != 1)
	{
		if (Level.NetMode == NM_DedicatedServer)
			return;
