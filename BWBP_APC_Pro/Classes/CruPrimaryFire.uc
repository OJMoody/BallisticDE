...
//=============================================================================
class CruPrimaryFire extends BallisticRangeAttenFire;
...
defaultproperties
{
     ...
     BallisticFireSound=(Sound=Sound'BWBP_CC_Sounds.MillitaryLaser.MG-Fire',Volume=1.200000,Slot=SLOT_Interact,bNoOverride=False)
