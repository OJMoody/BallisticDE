class E5PrimaryFire extends BallisticProProjectileFire;
...
function InitEffects()
{
    ...
    if (MuzzleFlashPulse == None || MuzzleFlashPulse.bDeleteMe )
		class'BUtil'.static.InitMuzzleFlash (MuzzleFlashPulse, class'E5FlashEmitter', Weapon.DrawScale*FlashScaleFactor, weapon, FlashBone);
    if (MuzzleFlashMulti == None || MuzzleFlashMulti.bDeleteMe )
		class'BUtil'.static.InitMuzzleFlash (MuzzleFlashMulti, class'E5SGFlashEmitter', Weapon.DrawScale*FlashScaleFactor, weapon, FlashBone);
