...
defaultproperties
{
     ...
     FriendlyName="BallisticPro: Manual Widgit Pickups"
     Description="Run over the Weapon and press the "Use" Key to pickup the Weapon. This Mutator enables Far Cry 2 alike weapon pickups and Borderlands alike overlays for the thrown pickups."
}
