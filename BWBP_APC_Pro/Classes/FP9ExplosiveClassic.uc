...
defaultproperties
{
     ...
     GunLength=0.000000
     bAimDisabled=True
     FireModeClass(0)=Class'BWBP_APC_Pro.FP9PrimaryFireClassic'
     FireModeClass(1)=Class'BWBP_APC_Pro.FP9SecondaryFireClassic'
     ...
     InventoryGroup=0
     GroupOffset=18
     PickupClass=Class'BWBP_APC_Pro.FP9PickupClassic'
     PlayerViewOffset=(X=10.000000,Y=-1.000000,Z=-6.000000)
     AttachmentClass=Class'BWBP_APC_Pro.FP9AttachmentClassic'
