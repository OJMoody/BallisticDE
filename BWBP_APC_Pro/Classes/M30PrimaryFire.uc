...
event ModeTick(float DT)
{
	...
	{
		DesiredFireRate = (FMin(1.0 / (60*M30Weapon.BarrelSpeed), 1));
...
simulated event ModeDoFire()
{
	...
	if (M30Weapon.BarrelSpeed <  M30Weapon.RotationSpeeds[0]) //M30Weapon.DesiredSpeed)
        return;
	*/
...
defaultproperties
{
     ...
     DamageType=Class'BWBP_APC_Pro.DTM30Rifle'
     DamageTypeHead=Class'BWBP_APC_Pro.DTM30RifleHead'
     DamageTypeArm=Class'BWBP_APC_Pro.DTM30Rifle'
     PenetrateForce=180
     bPenetrate=True
     ...
     MuzzleFlashClass=Class'BWBP_APC_Pro.M30FlashEmitter'
     FlashBone="tip"
     ...
     PreFireAnim=
     FireEndAnim=
     AmmoClass=Class'BWBP_APC_Pro.Ammo_M30'
