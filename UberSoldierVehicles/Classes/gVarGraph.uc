...
{
     bCalcCoords=True
     CBackground=(B=255,G=255,R=255,A=96)
     TBackground=Texture'Engine.MenuBlack'
     CText=(B=255,G=255,R=255,A=192)
     ItemMargin=1
     TextMargin=2
     ...
     GraphRange=255
     GraphFilter="None"
     CGraph(0)=(B=127,G=127,R=255,A=255)
     CGraph(1)=(B=127,G=255,R=255,A=255)
     CGraph(2)=(B=127,G=255,R=127,A=255)
     CGraph(3)=(B=224,G=255,R=127,A=255)
     CGraph(4)=(B=255,G=160,R=127,A=255)
     CGraph(5)=(B=255,G=127,R=127,A=255)
     GraphRescaleThresh=0.100000
     GraphRescaleTime=5.000000
     bRequiresTick=True
}
