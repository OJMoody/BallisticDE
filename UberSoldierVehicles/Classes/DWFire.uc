...
simulated event PreBeginPlay()
{
    ...
    if (Settings.FireMode == FM_Burning)
    {
        ...
        FireEffect = spawn(class'UltimateMappingTools.DWFireEmitter',self,,Location);
        FireEffect.SetBase(self);
        PhearMeh = spawn(class'UltimateMappingTools.DWFireFearSpot',,,Location);
...
defaultproperties
{
     ...
     Texture=Texture'UltimateMappingTools_Tex.Icons.fireicon'
     SoundVolume=200
     SoundPitch=50
