class BattleMasterT extends DKWeapons;

var Deco_BattleMasterTKorpus Korpus;
...
function PostBeginPlay()
{
	super.PostBeginPlay();
         ...
         Korpus = Spawn(class'Deco_BattleMasterTKorpus',self,, Location + (vect(0,0,0) << Rotation)); 
...
defaultproperties
{
     ...
     Spread=0.020000
     RedSkin=Shader'DKVehiclesTex.BattleMaster.BattleMasterT'
     BlueSkin=Shader'DKVehiclesTex.BattleMaster.BattleMasterT'
     FireInterval=12.200000
     AltFireInterval=12.200000
     FireSoundClass=SoundGroup'DKoppIISound.122mm'
     FireSoundVolume=255.000000
     FireSoundRadius=1000.000000
     AltFireSoundClass=SoundGroup'DKoppIISound.122mm'
     RotateSound=Sound'DKoppIISound.Turret.Turret_TurnB'
     ProjectileClass=Class'UberSoldierVehicles.PROJ_BattleMasterFG'
     AltFireProjectileClass=Class'UberSoldierVehicles.PROJ_BattleMasterAP'
     Mesh=SkeletalMesh'DKVehiclesAnim.BattleMasterT'
