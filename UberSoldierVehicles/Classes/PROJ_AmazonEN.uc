class PROJ_AmazonEN extends DKProjectile;
...
simulated function PostBeginPlay()
{
	...
	{
          Fire = Spawn(class'FX_FireEffect_AbramsMK2',,,Location); 
...
defaultproperties
{
     ...
     ImpactManager=Class'UberSoldierVehicles.IM_Ammo85EN'
     ...
     MyDamageType=Class'UberSoldierVehicles.DT_EN'
}
