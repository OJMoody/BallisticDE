...
defaultproperties
{
     ...
     LoadMonsterClass(0)=Class'UltimateMappingTools.AmbientSkaarjPupae'
     LoadMonsterClass(1)=Class'UltimateMappingTools.AmbientRazorfly'
     LoadMonsterClass(2)=Class'UltimateMappingTools.AmbientManta'
     RespawnTime=10.000000
     MaxMonsters=6
     Enabled=True
     bNoDelete=True
     Texture=Texture'UltimateMappingTools_Tex.Icons.monstericon'
}
