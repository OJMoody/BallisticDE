...
function PostBeginPlay()
{
	super.PostBeginPlay();
       ...
       if (Korpus==none) 
       { 
         Korpus = Spawn(class'Deco_IspolinKorpus',self,, Location + (vect(0,0,0) << Rotation)); 
...
Vector momentum, class<DamageType> damageType)
{
	...
	if ( (Health <= 0.55*HealthMax) && (EngineFire1 == none) )
	{
...
defaultproperties
{
     ...
     DriverWeapons(0)=(WeaponClass=Class'UberSoldierVehicles.IspolinT',WeaponBone="TurretCoords")
     PassengerWeapons(0)=(WeaponPawnClass=Class'UberSoldierVehicles.IspolinT2Pawn',WeaponBone="Turret2")
     ...
     End Object
     Wheels(0)=SVehicleWheel'UberSoldierVehicles.Ispolin.RWheel1'
     ...
     Begin Object Class=SVehicleWheel Name=RWheel2
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(1)=SVehicleWheel'UberSoldierVehicles.Ispolin.RWheel2'
     ...
     Begin Object Class=SVehicleWheel Name=RWheel3
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(2)=SVehicleWheel'UberSoldierVehicles.Ispolin.RWheel3'
     ...
     Begin Object Class=SVehicleWheel Name=RWheel4
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(3)=SVehicleWheel'UberSoldierVehicles.Ispolin.RWheel4'
     ...
     Begin Object Class=SVehicleWheel Name=RWheel5
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(4)=SVehicleWheel'UberSoldierVehicles.Ispolin.RWheel5'
     ...
     Begin Object Class=SVehicleWheel Name=RWheel6
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(5)=SVehicleWheel'UberSoldierVehicles.Ispolin.RWheel6'
     ...
     Begin Object Class=SVehicleWheel Name=RWheel7
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(6)=SVehicleWheel'UberSoldierVehicles.Ispolin.RWheel7'
     ...
     Begin Object Class=SVehicleWheel Name=Rwheel8
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(7)=SVehicleWheel'UberSoldierVehicles.Ispolin.Rwheel8'
     ...
     Begin Object Class=SVehicleWheel Name=LWheel1
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(8)=SVehicleWheel'UberSoldierVehicles.Ispolin.LWheel1'
     ...
     Begin Object Class=SVehicleWheel Name=LWheel2
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(9)=SVehicleWheel'UberSoldierVehicles.Ispolin.LWheel2'
     ...
     Begin Object Class=SVehicleWheel Name=LWheel3
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(10)=SVehicleWheel'UberSoldierVehicles.Ispolin.LWheel3'
     ...
     Begin Object Class=SVehicleWheel Name=LWheel4
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(11)=SVehicleWheel'UberSoldierVehicles.Ispolin.LWheel4'
     ...
     Begin Object Class=SVehicleWheel Name=LWheel5
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(12)=SVehicleWheel'UberSoldierVehicles.Ispolin.LWheel5'
     ...
     Begin Object Class=SVehicleWheel Name=LWheel6
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(13)=SVehicleWheel'UberSoldierVehicles.Ispolin.LWheel6'
     ...
     Begin Object Class=SVehicleWheel Name=LWheel7
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(14)=SVehicleWheel'UberSoldierVehicles.Ispolin.LWheel7'
     ...
     Begin Object Class=SVehicleWheel Name=Lwheel8
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(15)=SVehicleWheel'UberSoldierVehicles.Ispolin.Lwheel8'
     ...
     End Object
     KParams=KarmaParamsRBFull'UberSoldierVehicles.Ispolin.KParams0'
