class FX_PredatorHoverDust extends Emitter;
...
simulated function UpdateHoverDust(bool bActive, float HoverHeight)
{
	...
	// Rings
	Emitters[1].StartSizeRange.X.Min = 115 + (HoverHeight * 160);
	Emitters[1].StartSizeRange.X.Max = Emitters[1].StartSizeRange.X.Min + 100;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter0
         ...
         StartSizeRange=(X=(Min=75.000000,Max=75.000000),Y=(Min=0.000000,Max=0.000000),Z=(Min=0.000000,Max=0.000000))
     ...
     End Object
     Emitters(0)=SpriteEmitter'UberSoldierVehicles.FX_PredatorHoverDust.SpriteEmitter0'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1
         ...
         StartSizeRange=(X=(Min=180.000000,Max=200.000000),Y=(Min=200.000000,Max=200.000000),Z=(Min=200.000000,Max=200.000000))
         Texture=Texture'AW-2004Particles.Energy.AirBlast'
         LifetimeRange=(Min=0.300000,Max=0.300000)
     End Object
     Emitters(1)=SpriteEmitter'UberSoldierVehicles.FX_PredatorHoverDust.SpriteEmitter1'
