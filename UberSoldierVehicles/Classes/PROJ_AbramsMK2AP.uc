class PROJ_AbramsMK2AP extends DKProjectile;
...
simulated event HitWall(vector HitNormal, actor Wall)
{
   ...
   if (FRand() > 0.3) Spawn(class'PROJ_AbramsMK2APR',,,Location, NewRotation);
   }

   Spawn(class'PROJ_AbramsMK2AP_PS',self,,Location); 
...
defaultproperties
{
     ...
     ShakeRadius=185.000000
     MotionBlurRadius=185.000000
     MotionBlurFactor=10.000000
     Speed=20000.000000
     MaxSpeed=20000.000000
     Damage=850.000000
     DamageRadius=185.000000
