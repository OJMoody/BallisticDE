class PROJ_GatlingMG extends DKProjectile;

var vector Dir;
var FX_FireEffect_M1MG Fire;
...
simulated function PostBeginPlay()
{
	...
	{
          Fire = Spawn(class'FX_FireEffect_M1MG',self,,Location); 
...
defaultproperties
{
     ImpactManager=Class'UberSoldierVehicles.IM_AmmoMiniAP'
