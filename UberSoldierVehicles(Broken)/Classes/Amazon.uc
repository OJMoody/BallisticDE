...
// Amazon   //
//----------//
class Amazon extends DKVehicles;

var Deco_AmazonKorpus Korpus;

var Skel_Amazon_FlapA FlapA;
var Skel_Amazon_FlapR FlapR;
var Skel_Amazon_FlapL FlapL;
...
simulated function DrawHUD(Canvas Canvas)
{
        ...
        BGMaterial = Texture'DKVehiclesTex.Ammo.Ammo88EN';
...
function PostBeginPlay()
{
	super.PostBeginPlay();
         ...
         Korpus = Spawn(class'Deco_AmazonKorpus',self,, Location + (vect(0,0,0) << Rotation)); 
       AttachToBone(Korpus,'TankHull');

         FlapA = Spawn(class'Skel_Amazon_FlapA',self,, Location + (vect(0,0,0) << Rotation)); 
       AttachToBone(FlapA,'FlapA');

         FlapR = Spawn(class'Skel_Amazon_FlapR',self,, Location + (vect(0,0,0) << Rotation)); 
       AttachToBone(FlapR,'FlapR');

         FlapL = Spawn(class'Skel_Amazon_FlapL',self,, Location + (vect(0,0,0) << Rotation)); 
...
Vector momentum, class<DamageType> damageType)
{
	...
	if ( (Health <= 0.45*HealthMax) && (EngineSmoke2 == none) )
	{
...
defaultproperties
{
     ...
     DriverWeapons(0)=(WeaponClass=Class'UberSoldierVehicles.AmazonT',WeaponBone="TurretCoords")
     RedSkin=Shader'DKVehiclesTex.Amazon.Amazon'
     BlueSkin=Shader'DKVehiclesTex.Amazon.Amazon'
     ...
     End Object
     Wheels(0)=SVehicleWheel'UberSoldierVehicles.Amazon.RWheel1'
     ...
     Begin Object Class=SVehicleWheel Name=RWheel2
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(1)=SVehicleWheel'UberSoldierVehicles.Amazon.RWheel2'
     ...
     Begin Object Class=SVehicleWheel Name=RWheel3
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(2)=SVehicleWheel'UberSoldierVehicles.Amazon.RWheel3'
     ...
     Begin Object Class=SVehicleWheel Name=RWheel4
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(3)=SVehicleWheel'UberSoldierVehicles.Amazon.RWheel4'
     ...
     Begin Object Class=SVehicleWheel Name=RWheel5
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(4)=SVehicleWheel'UberSoldierVehicles.Amazon.RWheel5'
     ...
     Begin Object Class=SVehicleWheel Name=RWheel6
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(5)=SVehicleWheel'UberSoldierVehicles.Amazon.RWheel6'
     ...
     Begin Object Class=SVehicleWheel Name=RWheel7
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(6)=SVehicleWheel'UberSoldierVehicles.Amazon.RWheel7'
     ...
     Begin Object Class=SVehicleWheel Name=Rwheel8
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(7)=SVehicleWheel'UberSoldierVehicles.Amazon.Rwheel8'
     ...
     Begin Object Class=SVehicleWheel Name=LWheel1
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(8)=SVehicleWheel'UberSoldierVehicles.Amazon.LWheel1'
     ...
     Begin Object Class=SVehicleWheel Name=LWheel2
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(9)=SVehicleWheel'UberSoldierVehicles.Amazon.LWheel2'
     ...
     Begin Object Class=SVehicleWheel Name=LWheel3
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(10)=SVehicleWheel'UberSoldierVehicles.Amazon.LWheel3'
     ...
     Begin Object Class=SVehicleWheel Name=LWheel4
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(11)=SVehicleWheel'UberSoldierVehicles.Amazon.LWheel4'
     ...
     Begin Object Class=SVehicleWheel Name=LWheel5
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(12)=SVehicleWheel'UberSoldierVehicles.Amazon.LWheel5'
     ...
     Begin Object Class=SVehicleWheel Name=LWheel6
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(13)=SVehicleWheel'UberSoldierVehicles.Amazon.LWheel6'
     ...
     Begin Object Class=SVehicleWheel Name=LWheel7
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(14)=SVehicleWheel'UberSoldierVehicles.Amazon.LWheel7'
     ...
     Begin Object Class=SVehicleWheel Name=Lwheel8
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(15)=SVehicleWheel'UberSoldierVehicles.Amazon.Lwheel8'

     VehicleMass=10.000000
     ExitPositions(0)=(Y=-200.000000,Z=100.000000)
     ExitPositions(1)=(Y=200.000000,Z=100.000000)
     EntryRadius=300.000000
     FPCamPos=(X=40.000000,Z=250.000000)
     ...
     VehiclePositionString="Amazon"
     VehicleNameString="Amazon"
     HealthMax=1700.000000
     Health=1700
     Mesh=SkeletalMesh'DKVehiclesAnim.Amazon'
     ...
     Skins(4)=Shader'DKVehiclesTex.Amazon.AmazonT'
     ...
     End Object
     KParams=KarmaParamsRBFull'UberSoldierVehicles.Amazon.KParams0'
