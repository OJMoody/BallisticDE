...
defaultproperties
{
     ...
     Spread=0.020000
     RedSkin=Shader'DKVehiclesTex.IFV.IFVT'
     BlueSkin=Shader'DKVehiclesTex.IFV.IFVT'
     ...
     ProjectileClass=Class'UberSoldierVehicles.PROJ_M1BG'
     AltFireProjectileClass=Class'UberSoldierVehicles.PROJ_M1MG'
     AIInfo(0)=(RefireRate=0.850000)
     AIInfo(1)=(RefireRate=0.850000)
     Mesh=SkeletalMesh'DKVehiclesAnim.IFVT'
     DrawScale=0.750000
     Skins(0)=Shader'DKVehiclesTex.IFV.IFVT'
}
