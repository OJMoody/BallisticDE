...
// Abrams  //
//---------//
class Abrams extends DKVehicles;

var Deco_AbramsKorpus Korpus;

var Skel_Abrams_FlapL FlapL;
var Skel_Abrams_FlapR FlapR;
...
simulated function DrawHUD(Canvas Canvas)
{
        ...
        BGMaterial = Texture'DKVehiclesTex.Ammo.Ammo105';
        ...
        BGMaterial = Texture'DKVehiclesTex.Ammo.IconAmmo105';
...
function PostBeginPlay()
{
	super.PostBeginPlay();
         ...
         Korpus = Spawn(class'Deco_AbramsKorpus',self,, Location + (vect(0,0,-1) << Rotation)); 
       AttachToBone(Korpus,'TankHull');

         FlapL = Spawn(class'Skel_Abrams_FlapL',self,, Location + (vect(0,0,-1) << Rotation)); 
       AttachToBone(FlapL,'FlapL');

         FlapR = Spawn(class'Skel_Abrams_FlapR',self,, Location + (vect(0,0,-1) << Rotation)); 
...
static function StaticPrecache(LevelInfo L)
{
	...
	L.AddPrecacheMaterial(Material'DKVehiclesTex.Abrams.Abrams_Def');
	L.AddPrecacheMaterial(Material'DKVehiclesTex.Abrams.Abrams_Def_X');
	...
	L.AddPrecacheStaticMesh(StaticMesh'DKVehiclesMesh.Abrams.Abrams_X');
	L.AddPrecacheStaticMesh(StaticMesh'DKVehiclesMesh.Abrams.AbramsT_X');
...
{
	Level.AddPrecacheMaterial(Material'DKVehiclesTex.Abrams.Abrams_Def');
	Level.AddPrecacheMaterial(Material'DKVehiclesTex.Abrams.Abrams_Def_X');
...
{
	Level.AddPrecacheStaticMesh(StaticMesh'DKVehiclesMesh.Abrams.Abrams_X');
	Level.AddPrecacheStaticMesh(StaticMesh'DKVehiclesMesh.Abrams.AbramsT_X');
...
defaultproperties
{
     ...
     DriverWeapons(0)=(WeaponClass=Class'UberSoldierVehicles.AbramsT',WeaponBone="TurretCoords")
     PassengerWeapons(0)=(WeaponPawnClass=Class'UberSoldierVehicles.AbramsT2Pawn',WeaponBone="Turret2")
     ...
     End Object
     Wheels(0)=SVehicleWheel'UberSoldierVehicles.Abrams.RWheel1'
     ...
     Begin Object Class=SVehicleWheel Name=RWheel2
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(1)=SVehicleWheel'UberSoldierVehicles.Abrams.RWheel2'
     ...
     Begin Object Class=SVehicleWheel Name=RWheel3
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(2)=SVehicleWheel'UberSoldierVehicles.Abrams.RWheel3'
     ...
     Begin Object Class=SVehicleWheel Name=RWheel4
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(3)=SVehicleWheel'UberSoldierVehicles.Abrams.RWheel4'
     ...
     Begin Object Class=SVehicleWheel Name=RWheel5
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(4)=SVehicleWheel'UberSoldierVehicles.Abrams.RWheel5'
     ...
     Begin Object Class=SVehicleWheel Name=RWheel6
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(5)=SVehicleWheel'UberSoldierVehicles.Abrams.RWheel6'
     ...
     Begin Object Class=SVehicleWheel Name=RWheel7
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(6)=SVehicleWheel'UberSoldierVehicles.Abrams.RWheel7'
     ...
     Begin Object Class=SVehicleWheel Name=Rwheel8
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(7)=SVehicleWheel'UberSoldierVehicles.Abrams.Rwheel8'
     ...
     Begin Object Class=SVehicleWheel Name=LWheel1
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(8)=SVehicleWheel'UberSoldierVehicles.Abrams.LWheel1'
     ...
     Begin Object Class=SVehicleWheel Name=LWheel2
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(9)=SVehicleWheel'UberSoldierVehicles.Abrams.LWheel2'
     ...
     Begin Object Class=SVehicleWheel Name=LWheel3
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(10)=SVehicleWheel'UberSoldierVehicles.Abrams.LWheel3'
     ...
     Begin Object Class=SVehicleWheel Name=LWheel4
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(11)=SVehicleWheel'UberSoldierVehicles.Abrams.LWheel4'
     ...
     Begin Object Class=SVehicleWheel Name=LWheel5
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(12)=SVehicleWheel'UberSoldierVehicles.Abrams.LWheel5'
     ...
     Begin Object Class=SVehicleWheel Name=LWheel6
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(13)=SVehicleWheel'UberSoldierVehicles.Abrams.LWheel6'
     ...
     Begin Object Class=SVehicleWheel Name=LWheel7
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(14)=SVehicleWheel'UberSoldierVehicles.Abrams.LWheel7'
     ...
     Begin Object Class=SVehicleWheel Name=Lwheel8
         ...
         SupportBoneAxis=AXIS_Z
     End Object
     Wheels(15)=SVehicleWheel'UberSoldierVehicles.Abrams.Lwheel8'
     ...
     VehiclePositionString="Abrams"
     VehicleNameString="Abrams"
     HealthMax=1500.000000
     Health=1500
     Mesh=SkeletalMesh'DKVehiclesAnim.Abrams'
     ...
     End Object
     KParams=KarmaParamsRBFull'UberSoldierVehicles.Abrams.KParams0'
