...
defaultproperties
{
     ...
     TwisterChildClass=Class'UltimateMappingTools.DWTwisterChild'
     TwisterEffectClass=Class'UltimateMappingTools.DWTwisterEmitter'
     KickUpSpeed=80.000000
     DamageRadius=250.000000
     Damage=5.000000
     MyDamageType=Class'UltimateMappingTools.DamTypeTwister'
     bIsEffectedByWind=True
     bUpdateSimulatedPosition=True
     Physics=PHYS_Projectile
     AmbientSound=Sound'OutdoorAmbience.BThunder.Wind2'
     Texture=Texture'UltimateMappingTools_Tex.Icons.twistericon'
     bFullVolume=True
     SoundVolume=255
