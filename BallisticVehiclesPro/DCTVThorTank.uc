...
defaultproperties
{
     ...
     DriverWeapons(0)=(WeaponClass=Class'BallisticVehiclesPro.DCTVThorTankCannon',WeaponBone="TurretWeapon")
     PassengerWeapons(0)=(WeaponPawnClass=Class'BallisticVehiclesPro.DCTVThorTankMGPawn',WeaponBone="TankMGWeapon")
     ...
     DisintegrationEffectClass=Class'BallisticVehiclesPro.DCTVThorDisintegration'
     ...
     RanOverDamageType=Class'BallisticVehiclesPro.DT_ThorRoadKill'
     CrushedDamageType=Class'BallisticVehiclesPro.DT_ThorPanCake'
     ...
     Begin Object Class=KarmaParamsRBFull Name=KParams1
         ...
         KFriction=0.500000
     End Object
     KParams=KarmaParamsRBFull'BallisticVehiclesPro.DCTVThorTank.KParams1'
