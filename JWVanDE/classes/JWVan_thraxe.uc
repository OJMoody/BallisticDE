...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JWVanStatic.thraxeLD'
     PickupDrawScale=0.400000
     PickupMessage="You found a Throwing Axe. Go berserk!"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JWVanStatic.thraxe'
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_thraxe.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_thraxe.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1900
         ProjMass=15
         ProjMesh=StaticMesh'JWVanStatic.thraxeLD'
         ProjScale=0.250000
         ...
         KickForce=15000
         DamageType=Class'JWVanDE.DTthraxesec'
         RefireTime=0.400000
         AnimRate=1.500000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'JWVanDE.JWVan_thraxe.JunkThrowFireInfo0'
     ...
     NoUseThreshold=80
     StaticMesh=StaticMesh'JWVanStatic.thraxe'
     DrawScale=1.260000
}
