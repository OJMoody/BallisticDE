...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JWVanStatic.golfclubLD'
     PickupDrawScale=0.400000
     SpawnPivot=(Pitch=768)
     SpawnOffset=(Z=2.000000)
     PickupMessage="You got the Golf Club. FORE!"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JWVanStatic.golfclub'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=12000
         DamageType=Class'JWVanDE.DTgolfclub'
         RefireTime=0.650000
         AnimRate=1.200000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_golfclub.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_golfclub.JunkFireInfo1'
     ...
     StaticMesh=StaticMesh'JWVanStatic.golfclub'
     DrawScale=0.700000
}
