...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JWVanStatic.thrknifeLD'
     PickupDrawScale=0.400000
     PickupMessage="You found a Throwing Knife. Stealthy!"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JWVanStatic.thrknife'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=7000
         DamageType=Class'JWVanDE.DTthrknife'
         RefireTime=0.380000
         AnimRate=1.150000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_thrknife.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_thrknife.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=2000
         ProjMass=15
         ProjMesh=StaticMesh'JWVanStatic.thrknifeLD'
         ProjScale=0.250000
         ...
         KickForce=15000
         DamageType=Class'JWVanDE.DTthrknifesec'
         RefireTime=0.400000
         AnimRate=1.500000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'JWVanDE.JWVan_thrknife.JunkThrowFireInfo0'
     ...
     NoUseThreshold=80
     StaticMesh=StaticMesh'JWVanStatic.thrknife'
     DrawScale=1.560000
}
