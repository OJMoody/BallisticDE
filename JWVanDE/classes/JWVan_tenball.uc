...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JWVanStatic.tenball'
     PickupDrawScale=0.400000
     PickupMessage="You got a Tennis Ball. Well, it's something."
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JWVanStatic.tenball'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=2000
         DamageType=Class'JWVanDE.DTtenball'
         RefireTime=0.450000
         AnimRate=1.500000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_tenball.JunkFireInfo0'

     MeleeBFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_rock.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1300
         ProjMass=20
         ProjMesh=StaticMesh'JWVanStatic.tenball'
         ProjScale=0.250000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'JWVanDE.JWVan_tenball.JunkThrowFireInfo0'
     ...
     PainThreshold=12
     NoUseThreshold=20
     StaticMesh=StaticMesh'JWVanStatic.tenball'
     DrawScale=1.250000
}
