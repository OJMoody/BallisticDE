...
//=============================================================================
class JWVan_pin extends JunkObject;

defaultproperties
{
     HandOffset=(X=2.000000,Z=-2.000000)
     PickupMesh=StaticMesh'JWVanStatic.pinLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Bowling Pin. Strike someone."
     ThirdPersonDrawScale=0.140000
     ThirdPersonMesh=StaticMesh'JWVanStatic.Pin'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=3000
         DamageType=Class'JWVanDE.DTpin'
         RefireTime=0.500000
         AnimRate=1.500000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_pin.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_pin.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1500
         ProjMass=20
         ProjMesh=StaticMesh'JWVanStatic.pinLD'
         ProjScale=0.250000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'JWVanDE.JWVan_pin.JunkThrowFireInfo0'

     SelectSound=(Sound=SoundGroup'JunkWarSounds.Misc.Pullout-Avg')
     FriendlyName="Bowling Pin"
     MeleeRating=30.000000
     RangeRating=18.000000
     PainThreshold=10
     NoUseThreshold=25
     StaticMesh=StaticMesh'JWVanStatic.Pin'
     DrawScale=1.150000
}
