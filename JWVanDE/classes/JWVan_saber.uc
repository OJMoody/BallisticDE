...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JWVanStatic.saberLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Saber. Arrr!"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JWVanStatic.saber'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=7000
         DamageType=Class'JWVanDE.DTsaber'
         RefireTime=0.400000
         AnimRate=1.200000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_saber.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_saber.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1200
         ProjMass=25
         ProjMesh=StaticMesh'JWVanStatic.saberLD'
         ProjScale=0.250000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'JWVanDE.JWVan_saber.JunkThrowFireInfo0'
     ...
     NoUseThreshold=80
     StaticMesh=StaticMesh'JWVanStatic.saber'
     DrawScale=2.260000
}
