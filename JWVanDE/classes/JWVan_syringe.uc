...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JWVanStatic.syringeLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Syringe. Euthanize your enemies."
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JWVanStatic.Syringe'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=2000
         DamageType=Class'JWVanDE.DTsyringe'
         RefireTime=0.450000
         AnimRate=1.500000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_syringe.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_syringe.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=2000
         ProjMass=10
         ProjMesh=StaticMesh'JWVanStatic.syringeLD'
         ProjScale=0.250000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'JWVanDE.JWVan_syringe.JunkThrowFireInfo0'
     ...
     PainThreshold=12
     NoUseThreshold=20
     StaticMesh=StaticMesh'JWVanStatic.Syringe'
     DrawScale=1.250000
}
