...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JWVanStatic.horseshoeLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Horseshoe. Kick some ass with it."
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JWVanStatic.horseshoe'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=8000
         DamageType=Class'JWVanDE.DThorseshoe'
         RefireTime=0.650000
         AnimRate=1.100000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_horseshoe.JunkFireInfo0'
     ...
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_horseshoe.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=800
         ProjMass=50
         ProjMesh=StaticMesh'JWVanStatic.horseshoeLD'
         ProjScale=0.250000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'JWVanDE.JWVan_horseshoe.JunkThrowFireInfo0'
     ...
     PainThreshold=55
     StaticMesh=StaticMesh'JWVanStatic.horseshoe'
     DrawScale=1.350000
}
