...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JWVanStatic.showerLD'
     PickupDrawScale=0.400000
     PickupMessage="You found a Shower Head. Only a clean enemy is a good enemy."
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JWVanStatic.shower'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=7000
         DamageType=Class'JWVanDE.DTshower'
         RefireTime=0.600000
         AnimRate=1.200000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_shower.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_shower.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1500
         ProjMass=25
         ProjMesh=StaticMesh'JWVanStatic.showerLD'
         ProjScale=0.250000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'JWVanDE.JWVan_shower.JunkThrowFireInfo0'
     ...
     NoUseThreshold=80
     StaticMesh=StaticMesh'JWVanStatic.shower'
     DrawScale=1.160000
}
