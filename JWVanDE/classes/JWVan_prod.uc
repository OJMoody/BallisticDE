...
defaultproperties
{
     PickupMesh=StaticMesh'JWVanStatic.prodLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Cattle Prod. Zap dem suckas!"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JWVanStatic.Prod'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=90000
         DamageType=Class'JWVanDE.DTprod'
         RefireTime=0.400000
         AnimRate=1.500000
         Sound=(Sound=SoundGroup'JunkWarSounds.Crowbar.Crowbar-Swing',Volume=0.600000)
         Anims(0)="AvgHit1"
         Anims(1)="StabHit1"
         Anims(2)="AvgHit2"
         Anims(3)="StabHit2"
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_prod.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_prod.JunkFireInfo1'
     ...
     PainThreshold=25
     NoUseThreshold=50
     StaticMesh=StaticMesh'JWVanStatic.Prod'
}
