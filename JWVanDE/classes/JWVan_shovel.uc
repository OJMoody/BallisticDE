...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JWVanStatic.ShovelLD'
     ...
     ThirdPersonMesh=StaticMesh'JWVanStatic.Shovel'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'JWVanDE.IM_shovel'
         HookStopFactor=1.500000
         Damage=(head=140,Limb=40,Misc=100)
         KickForce=20000
         DamageType=Class'JWVanDE.DTshovel'
         RefireTime=1.250000
         AnimRate=1.500000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_shovel.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Early
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_shovel.JunkFireInfo1'
     ...
     StaticMesh=StaticMesh'JWVanStatic.Shovel'
     DrawScale=0.600000
}
