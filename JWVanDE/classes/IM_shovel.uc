...
// IM_shovel.
//
// Impact Manager for shovel
//
// by Nolan "Dark Carnivour" Richert.
// Copyright(c) 2006 RuneStorm. All Rights Reserved.
//=============================================================================
class IM_shovel extends BCShakeImpact;
...
defaultproperties
{
     ...
     HitSounds(0)=SoundGroup'jwvansound.Shovel.Shovel'
     HitSounds(1)=SoundGroup'jwvansound.Shovel.Shovel'
     HitSounds(2)=SoundGroup'JunkWarSounds.Conpole.Conpole-Dirt'
     HitSounds(3)=SoundGroup'jwvansound.Shovel.Shovel'
     HitSounds(4)=SoundGroup'JunkWarSounds.Conpole.Conpole-Wood'
     HitSounds(5)=SoundGroup'JunkWarSounds.Conpole.Conpole-Dirt'
     HitSounds(6)=SoundGroup'jwvansound.Shovel.Shovel'
     HitSounds(7)=SoundGroup'JunkWarSounds.Conpole.Conpole-Dirt'
     HitSounds(8)=SoundGroup'JunkWarSounds.Conpole.Conpole-Dirt'
     HitSounds(9)=Sound'JunkWarSounds.Misc.Water-Big'
     HitSounds(10)=SoundGroup'jwvansound.Shovel.Shovel'
