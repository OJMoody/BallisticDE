...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JWVanStatic.kitchforkLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Kitchen Fork. Pokey poke."
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JWVanStatic.kitchfork'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=5000
         DamageType=Class'JWVanDE.DTkitchfork'
         RefireTime=0.400000
         AnimRate=1.500000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_kitchfork.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_kitchfork.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1500
         ProjMass=20
         ProjMesh=StaticMesh'JWVanStatic.kitchforkLD'
         ProjScale=0.400000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'JWVanDE.JWVan_kitchfork.JunkThrowFireInfo0'
     ...
     PainThreshold=25
     NoUseThreshold=45
     StaticMesh=StaticMesh'JWVanStatic.kitchfork'
     DrawScale=2.000000
}
