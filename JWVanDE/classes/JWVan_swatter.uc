...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JWVanStatic.swatterLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Swatter. Bzzzzzzzz!"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JWVanStatic.swatter'
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_swatter.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_swatter.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1500
         ProjMass=20
         ProjMesh=StaticMesh'JWVanStatic.swatterLD'
         ProjScale=0.400000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'JWVanDE.JWVan_swatter.JunkThrowFireInfo0'
     ...
     PainThreshold=55
     StaticMesh=StaticMesh'JWVanStatic.swatter'
     DrawScale=1.350000
}
