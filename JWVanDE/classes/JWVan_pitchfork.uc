...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JWVanStatic.pitchforkLD'
     PickupDrawScale=0.400000
     SpawnPivot=(Pitch=768)
     SpawnOffset=(Z=2.000000)
     PickupMessage="You got the Pitchfork. RIOT!"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JWVanStatic.pitchfork'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=12000
         DamageType=Class'JWVanDE.DTpitchfork'
         RefireTime=0.650000
         AnimRate=1.200000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_pitchfork.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_pitchfork.JunkFireInfo1'
     ...
     StaticMesh=StaticMesh'JWVanStatic.pitchfork'
     DrawScale=0.700000
}
