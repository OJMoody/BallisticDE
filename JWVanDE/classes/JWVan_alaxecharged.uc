...
defaultproperties
{
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'JWVanDE.IM_alaxecharged'
         HookStopFactor=1.000000
         Damage=(head=110,Limb=30,Misc=45)
         KickForce=8000
         DamageType=Class'JWVanDE.DTalaxecharged'
         RefireTime=1.000000
         AnimRate=0.000001
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_alaxecharged.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimRate=0.000001
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_alaxecharged.JunkFireInfo1'
