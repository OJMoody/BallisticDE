...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JWVanStatic.hookswordLD'
     PickupDrawScale=0.400000
     PickupMessage="You found the Hooksword. Aaaye chin chin!"
     ThirdPersonDrawScale=0.300000
     ThirdPersonMesh=StaticMesh'JWVanStatic.hooksword'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=5000
         DamageType=Class'JWVanDE.DThooksword'
         RefireTime=0.400000
         AnimRate=1.200000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_hooksword.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_hooksword.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1200
         ProjMass=25
         ProjMesh=StaticMesh'JWVanStatic.hookswordLD'
         ProjScale=0.250000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'JWVanDE.JWVan_hooksword.JunkThrowFireInfo0'
     ...
     PainThreshold=25
     NoUseThreshold=45
     StaticMesh=StaticMesh'JWVanStatic.hooksword'
     DrawScale=2.400000
}
