...
defaultproperties
{
     ...
     DecalScale=0.750000
     HitSounds(0)=SoundGroup'jwvansound.plunger'
     HitSounds(1)=SoundGroup'jwvansound.plunger'
     HitSounds(2)=SoundGroup'JunkWarSounds.Wood.Wood-Dirt'
     HitSounds(3)=SoundGroup'jwvansound.plunger'
     HitSounds(4)=SoundGroup'JunkWarSounds.Wood.Wood-Wood'
     HitSounds(5)=SoundGroup'JunkWarSounds.Wood.Wood-Dirt'
     HitSounds(6)=SoundGroup'jwvansound.plunger'
     ...
     HitSounds(10)=SoundGroup'jwvansound.plunger'
