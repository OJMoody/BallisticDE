...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JWVanStatic.kukriLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Kukri. Shave some beards."
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JWVanStatic.kukri'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=5000
         DamageType=Class'JWVanDE.DTkukri'
         RefireTime=0.400000
         AnimRate=1.500000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_kukri.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_kukri.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1500
         ProjMass=20
         ProjMesh=StaticMesh'JWVanStatic.kukriLD'
         ProjScale=0.400000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'JWVanDE.JWVan_kukri.JunkThrowFireInfo0'
     ...
     PainThreshold=25
     NoUseThreshold=45
     StaticMesh=StaticMesh'JWVanStatic.kukri'
     DrawScale=2.000000
}
