...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JWVanStatic.bowling'
     PickupDrawScale=0.400000
     PickupMessage="You got a Bowling Ball. Striiiike!"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JWVanStatic.bowling'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=2000
         DamageType=Class'JWVanDE.DTbowling'
         RefireTime=0.450000
         AnimRate=1.500000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_bowling.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_bowling.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=700
         ProjMass=70
         ProjMesh=StaticMesh'JWVanStatic.bowling'
         ProjScale=0.250000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'JWVanDE.JWVan_bowling.JunkThrowFireInfo0'
     ...
     PainThreshold=12
     NoUseThreshold=20
     StaticMesh=StaticMesh'JWVanStatic.bowling'
     DrawScale=1.250000
}
