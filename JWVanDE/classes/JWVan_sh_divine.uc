...
defaultproperties
{
     ...
     BlockRate=15.500000
     rating=85.000000
     ShieldPropClass=Class'JWVanDE.JWVan_sh_divineProp'
     AttachOffset=(X=0.000000,Y=0.150000,Z=1.000000)
     AttachPivot=(Pitch=1024,Yaw=-16000,Roll=0)
     Health=3500
     HurtThreshold=5000
     MaxProtection=5000
     PickupClass=Class'JWVanDE.JWVan_sh_divinePickup'
     PlayerViewOffset=(X=-10.000000,Y=16.000000)
     AttachmentClass=Class'JWVanDE.JWVan_sh_divineAttachment'
