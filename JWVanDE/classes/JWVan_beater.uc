...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'JWVanStatic.beaterLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Beater. It's for beating. Literally."
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'JWVanStatic.beater'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=8000
         DamageType=Class'JWVanDE.DTbeater'
         RefireTime=0.650000
         AnimRate=1.100000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_beater.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         KickForce=15000
         DamageType=Class'JWVanDE.DTbeatersec'
         RefireTime=0.800000
         AnimRate=1.250000
         Sound=(Sound=SoundGroup'JunkWarSounds.Clubhammer.Clubhammer-Swing')
         Anims(0)="WideAttack"
     ...
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'JWVanDE.JWVan_beater.JunkFireInfo1'
     ...
     PainThreshold=55
     StaticMesh=StaticMesh'JWVanStatic.beater'
     DrawScale=1.350000
}
