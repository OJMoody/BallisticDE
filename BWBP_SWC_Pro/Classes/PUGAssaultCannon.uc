...
function float GetAIRating()
{
	...
	return class'BUtil'.static.DistanceAtten(Rating, 0.75, Dist, 768, 2048); 
}
...
defaultproperties
{
     ...
     GunLength=48.000000
     FireModeClass(0)=Class'BWBP_SWC_Pro.PUGPrimaryFire'
     FireModeClass(1)=Class'BWBP_SWC_Pro.PUGSecondaryFire'
     ...
     InventoryGroup=8
     GroupOffset=13
     PickupClass=Class'BWBP_SWC_Pro.PUGPickup'
     PlayerViewOffset=(X=12.000000,Y=8.000000,Z=-16.000000)
     BobDamping=1.600000
     AttachmentClass=Class'BWBP_SWC_Pro.PUGAttachment'
