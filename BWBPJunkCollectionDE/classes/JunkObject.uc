...
//=============================================================================
class JunkObject extends Info config(BWBPJunkCollectionDE) exportstructs;
...
defaultproperties
{
     JunkActorClass=Class'BWBPJunkCollectionDE.JunkActor'
     HandFOV=60.000000
     HandScale=1.000000
     ...
     ThirdPersonActorClass=Class'BWBPJunkCollectionDE.JunkWeaponAttachment'
