...
//=============================================================================
class Mut_JunkWar extends Mutator config(BWBPJunkCollectionDE);
...
function PostBeginPlay()
{
	...
	if (bNoOtherWeapons)
		DefaultWeaponName = "BWBPJunkCollectionDE.JunkWeapon";
...
function bool CheckReplacement(Actor Other, out byte bSuperRelevant)
{
	...
	if (bNoOtherWeapons)
	{
		if (xPawn(Other) != None)
		{
			xPawn(Other).RequiredEquipment[0] = "BWBPJunkCollectionDE.JunkWeapon";
...
defaultproperties
{
     ...
     ConfigMenuClassName="BWBPJunkCollectionDE.JunkWarConfigMenu"
