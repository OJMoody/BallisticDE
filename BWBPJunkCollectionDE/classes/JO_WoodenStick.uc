...
// JO_WoodenStick.
//
// A crudely cut wooden stick.
//
// by Nolan "Dark Carnivour" Richert.
// Copyright(c) 2006 RuneStorm. All Rights Reserved.
//=============================================================================
class JO_WoodenStick extends JunkObject;

defaultproperties
{
     PickupMesh=StaticMesh'BWBP_JW_Static.Junk.WoodenStickLD'
     PickupDrawScale=0.400000
     SpawnPivot=(Pitch=768)
     SpawnOffset=(Z=2.000000)
     PickupMessage="You got the Wooden Stick"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'BWBP_JW_Static.Junk.WoodenStick'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'BWBPJunkCollectionDE.IM_JunkWoodenStick'
         HookStopFactor=0.800000
         Damage=(head=92,Limb=20,Misc=42)
         KickForce=12000
         DamageType=Class'BWBPJunkCollectionDE.DTJunkWoodenStick'
         RefireTime=0.750000
         AnimRate=1.200000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JO_WoodenStick.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JO_WoodenStick.JunkFireInfo1'

     SelectSound=(Sound=SoundGroup'BWBP_JW_Sound.Misc.Pullout-Avg')
     FriendlyName="Crude Wooden Stick"
     InventoryGroup=4
     ...
     StaticMesh=StaticMesh'BWBP_JW_Static.Junk.WoodenStick'
     DrawScale=0.570000
}
