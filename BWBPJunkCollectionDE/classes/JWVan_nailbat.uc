...
//=============================================================================
class JWVan_nailbat extends JunkObject;
...
function bool DoDamage(WeaponFire Fire, JunkFireInfo FI, Actor Other, vector HitLocation, vector TraceStart, vector Dir, int PenetrateCount, int WallCount)
{
	...
	return false; //allows WeaponFire's DoDamage to be called
}

defaultproperties
{
     HandOffset=(X=4.000000,Z=-2.000000)
     PickupMesh=StaticMesh'BWBP_JW_Static.nailbatLD'
     PickupDrawScale=0.400000
     SpawnPivot=(Pitch=768)
     SpawnOffset=(Z=2.000000)
     PickupMessage="You got the Homerun Bat. Babe Ruth used this one!"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'BWBP_JW_Static.nailbat'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'BWBPJunkCollectionDE.IM_nailbat'
         Damage=(head=20,Limb=10,Misc=20)
         KickForce=300000
         DamageType=Class'BWBPJunkCollectionDE.DTnailbat'
         RefireTime=0.650000
         AnimRate=1.200000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_nailbat.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         ImpactManager=Class'BWBPJunkCollectionDE.IM_nailbat'
         Damage=(head=25,Limb=15,Misc=15)
         KickForce=300000
         DamageType=Class'BWBPJunkCollectionDE.DTnailbat'
         RefireTime=0.800000
         AnimRate=1.350000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_nailbat.JunkFireInfo1'

     SelectSound=(Sound=SoundGroup'BWBP_JW_Sound.Misc.Pullout-Avg')
     FriendlyName="Homerun Bat"
     InventoryGroup=4
     ...
     StaticMesh=StaticMesh'BWBP_JW_Static.nailbat'
     DrawScale=0.700000
}
