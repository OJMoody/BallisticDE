...
// Kukri.
//
// A crude blade for clearing bush and shaving tough beards. Two.
//
// by Nolan "Dark Carnivour" Richert.
// Copyright(c) 2006 RuneStorm. All Rights Reserved.
//=============================================================================
class JWVan_kukri extends JunkObject;

defaultproperties
{
     HandOffset=(X=4.000000,Y=2.000000,Z=-2.000000)
     PickupMesh=StaticMesh'BWBP_JW_Static.kukriLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Kukri. Shave some beards."
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'BWBP_JW_Static.kukri'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         Damage=(head=130,Limb=20,Misc=40)
         KickForce=5000
         DamageType=Class'BWBPJunkCollectionDE.DTkukri'
         RefireTime=0.400000
         AnimRate=1.500000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_kukri.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         HookStopFactor=0.700000
         HookPullForce=100.000000
         Damage=(head=150,Limb=22,Misc=50)
         KickForce=9000
         DamageType=Class'BWBPJunkCollectionDE.DTkukri'
         RefireTime=0.500000
         AnimRate=1.250000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_kukri.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1500
         ProjMass=20
         ProjMesh=StaticMesh'BWBP_JW_Static.kukriLD'
         ProjScale=0.400000
         ...
         bCanBePickedUp=True
         Damage=(head=120,Limb=35,Misc=40)
         KickForce=12000
         DamageType=Class'BWBPJunkCollectionDE.DTkukri'
         RefireTime=0.400000
         AnimRate=1.500000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'BWBPJunkCollectionDE.JWVan_kukri.JunkThrowFireInfo0'
     ...
     PainThreshold=25
     NoUseThreshold=45
     StaticMesh=StaticMesh'BWBP_JW_Static.kukri'
     DrawScale=2.000000
}
