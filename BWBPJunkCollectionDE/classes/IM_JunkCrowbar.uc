...
defaultproperties
{
     ...
     DecalScale=0.750000
     HitSounds(0)=SoundGroup'BWBP_JW_Sound.Crowbar.Crowbar-Concrete'
     HitSounds(1)=SoundGroup'BWBP_JW_Sound.Crowbar.Crowbar-Concrete'
     HitSounds(2)=SoundGroup'BWBP_JW_Sound.Crowbar.Crowbar-Dirt'
     HitSounds(3)=SoundGroup'BWBP_JW_Sound.Crowbar.Crowbar-Metal'
     HitSounds(4)=SoundGroup'BWBP_JW_Sound.Crowbar.Crowbar-Wood'
     HitSounds(5)=SoundGroup'BWBP_JW_Sound.Crowbar.Crowbar-Dirt'
     HitSounds(6)=SoundGroup'BWBP_JW_Sound.Flesh.Flesh-AvgBlunt'
     HitSounds(7)=SoundGroup'BWBP_JW_Sound.Crowbar.Crowbar-Dirt'
     HitSounds(8)=SoundGroup'BWBP_JW_Sound.Crowbar.Crowbar-Dirt'
     HitSounds(9)=Sound'BWBP_JW_Sound.Misc.Water-Avg'
     HitSounds(10)=SoundGroup'BWBP_JW_Sound.Crowbar.Crowbar-Concrete'
