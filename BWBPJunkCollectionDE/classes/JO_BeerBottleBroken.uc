...
defaultproperties
{
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'BWBPJunkCollectionDE.IM_JunkBeerBottleStab'
         HookStopFactor=1.200000
         Damage=(head=65,Limb=15,Misc=30)
         KickForce=5000
         DamageType=Class'BWBPJunkCollectionDE.DTJunkBeerBottleBroken'
         RefireTime=0.300000
         AnimRate=1.500000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JO_BeerBottleBroken.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         SwipePoints(3)=(Weight=4,offset=(Yaw=-1000))
         SwipePoints(4)=(Weight=2,offset=(Yaw=2000))
         ImpactManager=Class'BWBPJunkCollectionDE.IM_JunkBeerBottleStabSec'
         HookStopFactor=1.300000
         Damage=(head=82,Limb=25,Misc=40)
         KickForce=10000
         DamageType=Class'BWBPJunkCollectionDE.DTJunkBeerBottleBrokenSec'
         RefireTime=0.800000
         AnimRate=1.250000
         Sound=(Sound=SoundGroup'BWBP_JW_Sound.BeerBottle.BeerB-Swing')
         Anims(0)="StabAttack"
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JO_BeerBottleBroken.JunkFireInfo1'
     ...
     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         ...
         ExplodeManager=Class'BWBPJunkCollectionDE.IM_JunkBeerBottleBreak'
         Damage=(head=45,Limb=12,Misc=25)
         KickForce=10000
         DamageType=Class'BWBPJunkCollectionDE.DTJunkBeerBottle'
         RefireTime=0.400000
         AnimRate=1.250000
         Sound=(Sound=SoundGroup'BWBP_JW_Sound.BeerBottle.BeerB-Swing')
         Anims(0)="StabThrow"
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'BWBPJunkCollectionDE.JO_BeerBottleBroken.JunkThrowFireInfo0'
