//=============================================================================
// The Blazing Phoenix Fire Dildo.
//
// Uuuuuh. 
//
...
//=============================================================================
class JWVan_pener extends JunkObject;

defaultproperties
{
     HandOffset=(X=4.000000,Z=-2.000000)
     PickupMesh=StaticMesh'BWBP_JW_Static.penerLD'
     PickupDrawScale=0.350000
     PickupMessage="You found The Fabulous Phoenix Fire Dildo. What is this I don't even."
     ThirdPersonDrawScale=0.350000
     ThirdPersonMesh=StaticMesh'BWBP_JW_Static.pener'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         Damage=(head=130,Limb=80,Misc=40)
         KickForce=9000
         DamageType=Class'BWBPJunkCollectionDE.DTpener'
         RefireTime=0.400000
         AnimRate=1.500000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_pener.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_pener.JunkFireInfo1'

     FriendlyName="The Fabulous Phoenix Fire Dildo"
     InventoryGroup=4
     ...
     StaticMesh=StaticMesh'BWBP_JW_Static.pener'
     DrawScale=0.800000
}
