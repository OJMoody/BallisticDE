...
//=============================================================================
class JWVan_candle extends JunkObject;

defaultproperties
{
     HandOffset=(X=4.000000,Z=-6.000000)
     PickupMesh=StaticMesh'BWBP_JW_Static.candleLD'
     PickupDrawScale=0.500000
     SpawnOffset=(Z=2.000000)
     PickupMessage="You found a Candlestick. Enlighten some people!"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'BWBP_JW_Static.candle'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=30000
         DamageType=Class'BWBPJunkCollectionDE.DTcandle'
         RefireTime=1.400000
         AnimRate=1.200000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_candle.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_candle.JunkFireInfo1'

     SelectSound=(Sound=SoundGroup'BWBP_JW_Sound.Misc.Pullout-Heavy')
     FriendlyName="Candlestick"
     InventoryGroup=5
     ...
     StaticMesh=StaticMesh'BWBP_JW_Static.candle'
     DrawScale=0.800000
}
