...
//=============================================================================
class JWVan_pene extends JunkObject;

defaultproperties
{
     HandOffset=(X=4.000000,Z=-2.000000)
     PickupMesh=StaticMesh'BWBP_JW_Static.peneLD'
     PickupDrawScale=0.350000
     PickupMessage="You found The Penetrator. Fascinating."
     ThirdPersonDrawScale=0.350000
     ThirdPersonMesh=StaticMesh'BWBP_JW_Static.pene'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=9000
         DamageType=Class'BWBPJunkCollectionDE.DTpene'
         RefireTime=0.500000
         AnimRate=1.500000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_pene.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_pene.JunkFireInfo1'

     FriendlyName="The Penetrator"
     InventoryGroup=4
     ...
     StaticMesh=StaticMesh'BWBP_JW_Static.pene'
     DrawScale=0.800000
}
