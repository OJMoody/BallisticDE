...
defaultproperties
{
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'BWBPJunkCollectionDE.IM_JunkGlassSmallBreak'
         DestroyOn=BT_HitAnything
         Damage=(head=45,Limb=15,Misc=27)
         KickForce=2000
         DamageType=Class'BWBPJunkCollectionDE.DTJunkWineGlass'
         RefireTime=0.400000
         AnimRate=1.200000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JO_WineGlass.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JO_WineGlass.JunkFireInfo1'
     ...
     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         ...
         ExplodeManager=Class'BWBPJunkCollectionDE.IM_JunkGlassSmallBreak'
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'BWBPJunkCollectionDE.JO_WineGlass.JunkThrowFireInfo0'
