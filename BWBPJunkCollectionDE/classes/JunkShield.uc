...
//=============================================================================
class JunkShield extends Inventory config(BWBPJunkCollectionDE);
...
defaultproperties
{
     ...
     ShieldPropClass=Class'BWBPJunkCollectionDE.JunkShieldProp'
     ...
     PickupClass=Class'BWBPJunkCollectionDE.JunkShieldPickup'
     PlayerViewOffset=(X=-5.000000,Y=6.000000,Z=-18.000000)
     AttachmentClass=Class'BWBPJunkCollectionDE.JunkShieldAttachment'
