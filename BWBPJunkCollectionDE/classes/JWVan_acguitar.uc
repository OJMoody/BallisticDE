...
// JWVan_AcGuitar.
//
// Aeoeoeoeoeoeoeo, countreh soooooongz.
//
// by Nolan "Dark Carnivour" Richert.
// Copyright(c) 2006 RuneStorm. All Rights Reserved.
//=============================================================================
class JWVan_acguitar extends JunkObject;

defaultproperties
{
     HandOffset=(X=6.000000,Z=-2.000000)
     PickupMesh=StaticMesh'BWBP_JW_Static.acguitarLD'
     PickupDrawScale=0.400000
     SpawnPivot=(Pitch=768)
     SpawnOffset=(Z=2.000000)
     PickupMessage="You found an Acoustic Guitar. Make a song out of death screams!"
     ThirdPersonDrawScale=0.350000
     ThirdPersonMesh=StaticMesh'BWBP_JW_Static.acguitar'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'BWBPJunkCollectionDE.IM_ACGuitar'
         HookStopFactor=1.000000
         Damage=(head=110,Limb=25,Misc=50)
         KickForce=12000
         DamageType=Class'BWBPJunkCollectionDE.DTacguitar'
         RefireTime=0.800000
         AnimRate=1.200000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_acguitar.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_acguitar.JunkFireInfo1'

     SelectSound=(Sound=SoundGroup'BWBP_JW_Sound.Misc.Pullout-Avg')
     FriendlyName="Acoustic Guitar"
     InventoryGroup=4
     ...
     StaticMesh=StaticMesh'BWBP_JW_Static.acguitar'
     DrawScale=0.700000
}
