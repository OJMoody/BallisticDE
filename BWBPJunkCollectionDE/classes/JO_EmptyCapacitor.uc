...
defaultproperties
{
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'BWBPJunkCollectionDE.IM_JunkEmptyCapacitor'
         Damage=(head=75,Limb=12,Misc=30)
         KickForce=4000
         DamageType=Class'BWBPJunkCollectionDE.DTJunkEmptyCapacitor'
         RefireTime=0.600000
         AnimRate=1.000000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JO_EmptyCapacitor.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JO_EmptyCapacitor.JunkFireInfo1'
     ...
     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         ...
         ExplodeManager=Class'BWBPJunkCollectionDE.IM_JunkEmptyCapacitor'
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'BWBPJunkCollectionDE.JO_EmptyCapacitor.JunkThrowFireInfo0'
