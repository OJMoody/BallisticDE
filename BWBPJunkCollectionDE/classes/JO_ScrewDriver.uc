...
// JO_Screwdriver.
//
// A brand new Screw-Driver.
//
// by Nolan "Dark Carnivour" Richert.
// Copyright(c) 2006 RuneStorm. All Rights Reserved.
//=============================================================================
class JO_Screwdriver extends JunkObject;

defaultproperties
{
     HandOffset=(X=3.000000,Z=-2.000000)
     PickupMesh=StaticMesh'BWBP_JW_Static.Junk.ScrewDriverLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the ScrewDriver"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'BWBP_JW_Static.Junk.ScrewDriver'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         Damage=(head=77,Limb=15,Misc=27)
         KickForce=2000
         DamageType=Class'BWBPJunkCollectionDE.DTJunkScrewDriver'
         RefireTime=0.250000
         AnimRate=1.500000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JO_ScrewDriver.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         HookStopFactor=1.500000
         HookPullForce=90.000000
         Damage=(head=85,Limb=17,Misc=32)
         KickForce=3000
         DamageType=Class'BWBPJunkCollectionDE.DTJunkScrewDriverSec'
         RefireTime=0.350000
         AnimRate=1.250000
         Sound=(Sound=SoundGroup'BWBP_JW_Sound.Spanner.Spanner-Swing')
         Anims(0)="StabAttack"
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JO_ScrewDriver.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=2000
         ProjMass=10
         ProjMesh=StaticMesh'BWBP_JW_Static.Junk.ScrewDriverLD'
         ProjScale=0.250000
         ...
         ImpactManager=Class'BWBPJunkCollectionDE.IM_JunkScrewDriver'
         bCanBePickedUp=True
         Damage=(head=67,Limb=12,Misc=30)
         KickForce=2000
         DamageType=Class'BWBPJunkCollectionDE.DTJunkScrewDriver'
         RefireTime=0.300000
         AnimRate=1.500000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'BWBPJunkCollectionDE.JO_ScrewDriver.JunkThrowFireInfo0'

     SelectSound=(Sound=SoundGroup'BWBP_JW_Sound.Misc.Pullout-Small')
     FriendlyName="Screwdriver"
     InventoryGroup=3
     ...
     PainThreshold=12
     NoUseThreshold=20
     StaticMesh=StaticMesh'BWBP_JW_Static.Junk.ScrewDriver'
     DrawScale=1.250000
}
