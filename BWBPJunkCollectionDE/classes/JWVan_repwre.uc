...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'BWBP_JW_Static.repwreLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Repairing Wrench, plumb some heads off."
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'BWBP_JW_Static.repwre'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'BWBPJunkCollectionDE.IM_JunkWrench'
         HookStopFactor=1.000000
         Damage=(head=110,Limb=24,Misc=45)
         KickForce=10000
         DamageType=Class'BWBPJunkCollectionDE.DTrepwre'
         RefireTime=0.600000
         AnimRate=1.200000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_repwre.JunkFireInfo0'
     ...
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_repwre.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1500
         ProjMass=20
         ProjMesh=StaticMesh'BWBP_JW_Static.repwreLD'
         ProjScale=0.250000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'BWBPJunkCollectionDE.JWVan_repwre.JunkThrowFireInfo0'
     ...
     PainThreshold=40
     NoUseThreshold=80
     StaticMesh=StaticMesh'BWBP_JW_Static.repwre'
     DrawScale=1.200000
}
