...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'BWBP_JW_Static.FalchionLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Falchion. Cut.. with style!"
     ThirdPersonDrawScale=0.450000
     ThirdPersonMesh=StaticMesh'BWBP_JW_Static.Falchion'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=7000
         DamageType=Class'BWBPJunkCollectionDE.DTfalchion'
         RefireTime=0.600000
         AnimRate=1.050000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_falchion.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_falchion.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=900
         ProjMass=35
         ProjMesh=StaticMesh'BWBP_JW_Static.FalchionLD'
         ProjScale=0.250000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'BWBPJunkCollectionDE.JWVan_falchion.JunkThrowFireInfo0'
     ...
     NoUseThreshold=80
     StaticMesh=StaticMesh'BWBP_JW_Static.Falchion'
     DrawScale=2.260000
}
