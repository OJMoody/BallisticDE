...
//=============================================================================
class JWVan_dwarfaxe extends JunkObject;

defaultproperties
{
     HandOffset=(X=4.000000,Z=-6.000000)
     PickupMesh=StaticMesh'BWBP_JW_Static.dwarfaxeLD'
     PickupDrawScale=0.400000
     SpawnOffset=(Z=2.000000)
     PickupMessage="You got the Dwarven Dragon Slayer. It does +50 damage agains dragon."
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'BWBP_JW_Static.dwarfaxe'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         MeleeRange=(Min=232.000000,Max=232.000000)
         SwipeHitWallPoint=6
         ...
         ImpactManager=Class'BWBPJunkCollectionDE.IM_JunkFireAxe'
         HookStopFactor=1.600000
         HookPullForce=100.000000
         Damage=(head=225,Limb=105,Misc=125)
         KickForce=40000
         DamageType=Class'BWBPJunkCollectionDE.DTdwarfaxe'
         RefireTime=1.100000
         AnimRate=1.400000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_dwarfaxe.JunkFireInfo0'

     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         MeleeRange=(Min=242.000000,Max=242.000000)
         SwipeHitWallPoint=6
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_dwarfaxe.JunkFireInfo1'

     SelectSound=(Sound=SoundGroup'BWBP_JW_Sound.Misc.Pullout-Heavy')
     FriendlyName="Dwarven Dragonslayer"
     InventoryGroup=5
     ...
     StaticMesh=StaticMesh'BWBP_JW_Static.dwarfaxe'
     DrawScale=0.800000
}
