...
defaultproperties
{
     ...
     HitSounds(0)=Sound'BWBP_JW_Sound.Extra.ShovelSound'
     HitSounds(1)=Sound'BWBP_JW_Sound.Extra.ShovelSound'
     HitSounds(2)=SoundGroup'BWBP_JW_Sound.Conpole.Conpole-Dirt'
     HitSounds(3)=Sound'BWBP_JW_Sound.Extra.ShovelSound'
     HitSounds(4)=SoundGroup'BWBP_JW_Sound.Conpole.Conpole-Wood'
     HitSounds(5)=SoundGroup'BWBP_JW_Sound.Conpole.Conpole-Dirt'
     HitSounds(6)=Sound'BWBP_JW_Sound.Extra.ShovelSound'
     ...
     HitSounds(10)=Sound'BWBP_JW_Sound.Extra.ShovelSound'
