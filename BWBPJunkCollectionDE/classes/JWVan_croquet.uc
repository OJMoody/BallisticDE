...
//=============================================================================
class JWVan_croquet extends JunkObject;

defaultproperties
{
     HandOffset=(X=4.000000,Z=-2.000000)
     PickupMesh=StaticMesh'BWBP_JW_Static.croquetLD'
     PickupDrawScale=0.350000
     PickupMessage="You got the Croquet Mallet. Skull crushing is imminent."
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'BWBP_JW_Static.croquet'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=9000
         DamageType=Class'BWBPJunkCollectionDE.DTcroquet'
         RefireTime=0.500000
         AnimRate=1.500000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_croquet.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_croquet.JunkFireInfo1'

     FriendlyName="Croquet Mallet"
     InventoryGroup=4
     ...
     StaticMesh=StaticMesh'BWBP_JW_Static.croquet'
     DrawScale=0.800000
}
