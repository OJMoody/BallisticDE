...
//=============================================================================
class JunkWeapon extends BallisticWeapon config(BWBPJunkCollectionDE) HideDropDown CacheExempt;
...
defaultproperties
{
     ...
     GunLength=0.000000
     bAimDisabled=True
     FireModeClass(0)=Class'BWBPJunkCollectionDE.JunkMeleeFire'
     FireModeClass(1)=Class'BWBPJunkCollectionDE.JunkRangedFire'
     IdleAnim="AvgIdle"
     ...
     CenteredRoll=0
     GroupOffset=5
     PickupClass=Class'BWBPJunkCollectionDE.JunkWeaponPickup'
     PlayerViewOffset=(X=-20.000000,Y=8.000000,Z=-14.000000)
     AttachmentClass=Class'BWBPJunkCollectionDE.JunkWeaponAttachment'
