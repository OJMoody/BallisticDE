...
// JO_SledgeHammer.
//
// A huge hammer for the absolute destruction of masonry.
//
// by Nolan "Dark Carnivour" Richert.
// Copyright(c) 2006 RuneStorm. All Rights Reserved.
//=============================================================================
class JO_SledgeHammer extends JunkObject;

defaultproperties
{
     HandOffset=(X=2.000000,Z=-3.000000)
     PickupMesh=StaticMesh'BWBP_JW_Static.Junk.SledgeHammerLD'
     PickupDrawScale=0.400000
     SpawnPivot=(Pitch=768)
     SpawnOffset=(Z=2.000000)
     PickupMessage="You got the Sledge Hammer"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'BWBP_JW_Static.Junk.SledgeHammer'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'BWBPJunkCollectionDE.IM_JunkSledgeHammer'
         HookStopFactor=1.000000
         Damage=(head=130,Limb=35,Misc=95)
         KickForce=25000
         DamageType=Class'BWBPJunkCollectionDE.DTJunkSledgeHammer'
         RefireTime=1.100000
         AnimRate=1.400000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JO_SledgeHammer.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         ImpactManager=Class'BWBPJunkCollectionDE.IM_JunkSledgeHammer'
         HookStopFactor=1.000000
         Damage=(head=145,Limb=45,Misc=107)
         KickForce=35000
         DamageType=Class'BWBPJunkCollectionDE.DTJunkSledgeHammer'
         RefireTime=1.250000
         AnimRate=1.350000
         ...
         AnimTimedFire=ATS_Early
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JO_SledgeHammer.JunkFireInfo1'

     SelectSound=(Sound=SoundGroup'BWBP_JW_Sound.Misc.Pullout-Heavy')
     FriendlyName="Sledge Hammer"
     InventoryGroup=5
     MeleeRating=145.000000
     RangeRating=0.000000
     SpawnWeight=0.950000
     ...
     StaticMesh=StaticMesh'BWBP_JW_Static.Junk.SledgeHammer'
     DrawScale=0.630000
}
