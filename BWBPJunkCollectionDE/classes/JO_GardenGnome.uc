...
//simulated function bool HitActor (Actor Other, JunkMeleeFireInfo FireInfo)
{
	if (FRand() < 0.12)
	{
		MorphedJunk=Class'BWBPJunkCollectionDE.JO_GardenGnomeWar';
	}
	else if (FRand() > 0.94)
	{
		MorphedJunk=Class'BWBPJunkCollectionDE.JO_GardenGnomeDaemon';
	}
	else
	{
		MorphedJunk=Class'BWBPJunkCollectionDE.JO_GardenGnome';
	}
}

simulated function Uninitialize (JunkObject NewJunkObject)
{
	if (MorphedJunk == Class'BWBPJunkCollectionDE.JO_GardenGnomeWar')
...
defaultproperties
{
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'BWBPJunkCollectionDE.IM_JunkClubHammer'
         MorphOn=BT_HitActor
         Damage=(head=64,Limb=33,Misc=43)
         KickForce=4000
         DamageType=Class'BWBPJunkCollectionDE.DTJunkGnome'
         RefireTime=0.600000
         AnimRate=1.000000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JO_GardenGnome.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JO_GardenGnome.JunkFireInfo1'
     ...
     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         ...
         ImpactManager=Class'BWBPJunkCollectionDE.IM_JunkClubHammer'
         ExplodeManager=Class'BWBPJunkCollectionDE.IM_JunkClubHammer'
         bCanBePickedUp=True
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'BWBPJunkCollectionDE.JO_GardenGnome.JunkThrowFireInfo0'
