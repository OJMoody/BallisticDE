...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'BWBP_JW_Static.bananaLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Banana. Yeah."
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'BWBP_JW_Static.banana'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=3000
         DamageType=Class'BWBPJunkCollectionDE.DTbanana'
         RefireTime=0.500000
         AnimRate=1.500000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_banana.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_banana.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1500
         ProjMass=20
         ProjMesh=StaticMesh'BWBP_JW_Static.bananaLD'
         ProjScale=0.250000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'BWBPJunkCollectionDE.JWVan_banana.JunkThrowFireInfo0'
     ...
     PainThreshold=10
     NoUseThreshold=25
     StaticMesh=StaticMesh'BWBP_JW_Static.banana'
     DrawScale=1.250000
}
