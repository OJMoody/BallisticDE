...
// JO_BaseBallBat.
//
// Standard Base-Ball Bat. A favourite of "debt collectors".
//
// by Nolan "Dark Carnivour" Richert.
// Copyright(c) 2006 RuneStorm. All Rights Reserved.
//=============================================================================
class JO_BaseBallBat extends JunkObject;

defaultproperties
{
     HandOffset=(X=4.000000,Z=-2.000000)
     PickupMesh=StaticMesh'BWBP_JW_Static.Junk.BaseBallBatLD'
     PickupDrawScale=0.350000
     PickupMessage="You got the BaseBall Bat. Break some legs."
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'BWBP_JW_Static.Junk.BaseBallBat'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'BWBPJunkCollectionDE.IM_JunkTwoByFour'
         HookStopFactor=1.000000
         Damage=(head=90,Limb=15,Misc=32)
         KickForce=9000
         DamageType=Class'BWBPJunkCollectionDE.DTJunkBaseballBat'
         RefireTime=0.500000
         AnimRate=1.500000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JO_BaseBallBat.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         Damage=(head=110,Limb=17,Misc=45)
         KickForce=12000
         DamageType=Class'BWBPJunkCollectionDE.DTJunkBaseballBat'
         RefireTime=0.800000
         AnimRate=1.250000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JO_BaseBallBat.JunkFireInfo1'

     FriendlyName="Base Ball Bat"
     InventoryGroup=4
     ...
     StaticMesh=StaticMesh'BWBP_JW_Static.Junk.BaseBallBat'
     DrawScale=0.800000
}
