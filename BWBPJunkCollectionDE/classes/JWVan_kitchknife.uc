...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'BWBP_JW_Static.kitchknifeLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Kitchen Knife. Nom!"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'BWBP_JW_Static.kitchknife'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=5000
         DamageType=Class'BWBPJunkCollectionDE.DTkitchknife'
         RefireTime=0.400000
         AnimRate=1.500000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_kitchknife.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_kitchknife.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1500
         ProjMass=20
         ProjMesh=StaticMesh'BWBP_JW_Static.kitchknifeLD'
         ProjScale=0.400000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'BWBPJunkCollectionDE.JWVan_kitchknife.JunkThrowFireInfo0'
     ...
     PainThreshold=25
     NoUseThreshold=45
     StaticMesh=StaticMesh'BWBP_JW_Static.kitchknife'
     DrawScale=2.400000
}
