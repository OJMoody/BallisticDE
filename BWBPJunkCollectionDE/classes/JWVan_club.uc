...
//=============================================================================
class JWVan_club extends JunkObject;

defaultproperties
{
     HandOffset=(X=4.000000,Z=-2.000000)
     PickupMesh=StaticMesh'BWBP_JW_Static.clubLD'
     PickupDrawScale=0.420000
     PickupMessage="You got the War Club. Burst some skulls asunder!"
     ThirdPersonDrawScale=0.350000
     ThirdPersonMesh=StaticMesh'BWBP_JW_Static.club'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         MeleeRange=(Min=190.000000,Max=190.000000)
         SwipeHitWallPoint=3
         ...
         KickForce=9000
         DamageType=Class'BWBPJunkCollectionDE.DTclub'
         RefireTime=0.700000
         AnimRate=1.350000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_club.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         Damage=(head=130,Limb=40,Misc=65)
         KickForce=12000
         DamageType=Class'BWBPJunkCollectionDE.DTclub'
         RefireTime=0.800000
         AnimRate=1.250000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_club.JunkFireInfo1'

     FriendlyName="War Club"
     InventoryGroup=4
     ...
     StaticMesh=StaticMesh'BWBP_JW_Static.club'
}
