...
// Chakra.
//
// ITZ LIEK SHURIKAN JUSTZ ROUNDZ.
//
// by Nolan "Dark Carnivour" Richert.
// Copyright(c) 2006 RuneStorm. All Rights Reserved.
//=============================================================================
class JWVan_chakra extends JunkObject;

defaultproperties
{
     HandOffset=(X=3.000000,Z=-2.000000)
     PickupMesh=StaticMesh'BWBP_JW_Static.chakraLD'
     PickupDrawScale=0.400000
     PickupMessage="You found a Chakram. Indian style!"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'BWBP_JW_Static.chakra'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         Damage=(head=85,Limb=25,Misc=55)
         KickForce=2000
         DamageType=Class'BWBPJunkCollectionDE.DTchakra'
         RefireTime=0.250000
         AnimRate=1.500000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_chakra.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         HookStopFactor=1.500000
         HookPullForce=90.000000
         Damage=(head=80,Limb=38,Misc=35)
         KickForce=3000
         DamageType=Class'BWBPJunkCollectionDE.DTchakra'
         RefireTime=0.350000
         AnimRate=1.250000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_chakra.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=2500
         ProjMass=12
         ProjMesh=StaticMesh'BWBP_JW_Static.chakraLD'
         ProjScale=0.250000
         WallImpactType=IT_Bounce
         ActorImpactType=IT_Stick
         SpinRates=(Pitch=900000)
         ImpactManager=Class'BWBPJunkCollectionDE.IM_JunkSpanner'
         bCanBePickedUp=True
         Damage=(head=120,Limb=22,Misc=45)
         KickForce=2500
         DamageType=Class'BWBPJunkCollectionDE.DTchakra'
         RefireTime=0.400000
         AnimRate=1.500000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'BWBPJunkCollectionDE.JWVan_chakra.JunkThrowFireInfo0'

     SelectSound=(Sound=SoundGroup'BWBP_JW_Sound.Misc.Pullout-Small')
     FriendlyName="Chakram"
     InventoryGroup=3
     ...
     PainThreshold=12
     NoUseThreshold=20
     StaticMesh=StaticMesh'BWBP_JW_Static.chakra'
     DrawScale=1.500000
}
