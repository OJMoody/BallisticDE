...
// Battleaxe.
//
// Orcs use this. Usually.
//
// by Nolan "Dark Carnivour" Richert.
// Copyright(c) 2006 RuneStorm. All Rights Reserved.
//=============================================================================
class JWVan_battleaxe extends JunkObject;

defaultproperties
{
     HandOffset=(X=4.000000,Z=-6.000000)
     PickupMesh=StaticMesh'BWBP_JW_Static.battleaxeLD'
     PickupDrawScale=0.400000
     SpawnOffset=(Z=2.000000)
     PickupMessage="You got the Battle Axe. It will probably kill somebody."
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'BWBP_JW_Static.BattleAxe'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         Damage=(head=195,Limb=65,Misc=120)
         KickForce=40000
         DamageType=Class'BWBPJunkCollectionDE.DTbattleaxe'
         RefireTime=1.100000
         AnimRate=1.400000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_battleaxe.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         HookStopFactor=1.600000
         HookPullForce=100.000000
         Damage=(head=200,Limb=85,Misc=130)
         KickForce=50000
         DamageType=Class'BWBPJunkCollectionDE.DTbattleaxe'
         RefireTime=1.250000
         AnimRate=1.350000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_battleaxe.JunkFireInfo1'
     ...
     StaticMesh=StaticMesh'BWBP_JW_Static.BattleAxe'
     DrawScale=0.800000
}
