...
defaultproperties
{
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'BWBPJunkCollectionDE.IM_JunkShankHit'
         HookStopFactor=1.000000
         HookPullForce=80.000000
         Damage=(head=90,Limb=15,Misc=32)
         KickForce=8000
         DamageType=Class'BWBPJunkCollectionDE.DTJunkShank'
         RefireTime=0.400000
         AnimRate=1.250000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JO_MetalShank.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         ImpactManager=Class'BWBPJunkCollectionDE.IM_JunkShankHitSec'
         HookStopFactor=1.000000
         HookPullForce=80.000000
         Damage=(head=105,Limb=17,Misc=45)
         KickForce=10000
         DamageType=Class'BWBPJunkCollectionDE.DTJunkShankSec'
         RefireTime=0.700000
         AnimRate=1.250000
         Sound=(Sound=SoundGroup'BWBP_JW_Sound.Pipe.Pipe-Swing')
         Anims(0)="StabAttack"
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JO_MetalShank.JunkFireInfo1'
     ...
     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'BWBPJunkCollectionDE.JO_MetalShank.JunkThrowFireInfo0'
