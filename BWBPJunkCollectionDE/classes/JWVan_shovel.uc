...
//=============================================================================
class JWVan_shovel extends JunkObject;

defaultproperties
{
     HandOffset=(X=2.000000,Z=-6.000000)
     PickupMesh=StaticMesh'BWBP_JW_Static.ShovelLD'
     PickupDrawScale=0.400000
     SpawnPivot=(Pitch=768)
     SpawnOffset=(Z=2.000000)
     PickupMessage="You got the Shovel. Smash your enemies and bury them afterwards."
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'BWBP_JW_Static.Shovel'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'BWBPJunkCollectionDE.IM_shovel'
         HookStopFactor=1.500000
         Damage=(head=140,Limb=40,Misc=100)
         KickForce=20000
         DamageType=Class'BWBPJunkCollectionDE.DTshovel'
         RefireTime=1.250000
         AnimRate=1.500000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_shovel.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Early
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_shovel.JunkFireInfo1'
     ...
     StaticMesh=StaticMesh'BWBP_JW_Static.Shovel'
     DrawScale=0.600000
}
