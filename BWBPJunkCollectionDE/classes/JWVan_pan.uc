...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'BWBP_JW_Static.panLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Frying Pan. You won't use it for frying though..."
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'BWBP_JW_Static.pan'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'BWBPJunkCollectionDE.IM_pan'
         HookStopFactor=1.000000
         Damage=(head=110,Limb=30,Misc=45)
         KickForce=8000
         DamageType=Class'BWBPJunkCollectionDE.DTpan'
         RefireTime=0.650000
         AnimRate=1.100000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_pan.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Early
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_pan.JunkFireInfo1'
     ...
     PainThreshold=55
     StaticMesh=StaticMesh'BWBP_JW_Static.pan'
     DrawScale=1.350000
}
