...
//=============================================================================
class JWVan_shark extends JunkObject;

defaultproperties
{
     HandOffset=(X=4.000000,Z=-6.000000)
     PickupMesh=StaticMesh'BWBP_JW_Static.sharkLD'
     PickupDrawScale=0.500000
     SpawnOffset=(Z=2.000000)
     PickupMessage="You found the Stuffed Shark. Now that's some hardcore shit!"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'BWBP_JW_Static.Shark'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         Damage=(head=200,Limb=90,Misc=120)
         KickForce=30000
         DamageType=Class'BWBPJunkCollectionDE.DTshark'
         RefireTime=1.400000
         AnimRate=1.200000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_shark.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         HookStopFactor=1.600000
         HookPullForce=100.000000
         Damage=(head=220,Limb=125,Misc=130)
         KickForce=50000
         DamageType=Class'BWBPJunkCollectionDE.DTshark'
         RefireTime=0.900000
         AnimRate=1.250000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_shark.JunkFireInfo1'

     SelectSound=(Sound=SoundGroup'BWBP_JW_Sound.Misc.Pullout-Heavy')
     FriendlyName="Stuffed Shark"
     InventoryGroup=5
     ...
     StaticMesh=StaticMesh'BWBP_JW_Static.Shark'
     DrawScale=0.800000
}
