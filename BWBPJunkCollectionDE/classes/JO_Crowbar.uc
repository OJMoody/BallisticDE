...
// JO_Crowbar.
//
// A large steel tool for prying open problems that just don't wanna go.
//
// by Nolan "Dark Carnivour" Richert.
// Copyright(c) 2006 RuneStorm. All Rights Reserved.
//=============================================================================
class JO_Crowbar extends JunkObject;

defaultproperties
{
     HandOffset=(X=5.000000,Y=2.000000,Z=-2.000000)
     PickupMesh=StaticMesh'BWBP_JW_Static.Junk.CrowbarLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Crowbar."
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'BWBP_JW_Static.Junk.Crowbar'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=7000
         DamageType=Class'BWBPJunkCollectionDE.DTJunkCrowbar'
         RefireTime=0.600000
         AnimRate=1.200000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JO_Crowbar.JunkFireInfo0'
     ...
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JO_Crowbar.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1200
         ProjMass=25
         ProjMesh=StaticMesh'BWBP_JW_Static.Junk.CrowbarLD'
         ProjScale=0.250000
         ...
         bCanBePickedUp=True
         Damage=(head=87,Limb=20,Misc=35)
         KickForce=15000
         DamageType=Class'BWBPJunkCollectionDE.DTJunkCrowbar'
         RefireTime=0.400000
         AnimRate=1.500000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'BWBPJunkCollectionDE.JO_Crowbar.JunkThrowFireInfo0'
     ...
     NoUseThreshold=80
     StaticMesh=StaticMesh'BWBP_JW_Static.Junk.Crowbar'
     DrawScale=1.160000
}
