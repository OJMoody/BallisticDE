...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'BWBP_JW_Static.pinLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Bowling Pin. Strike someone."
     ThirdPersonDrawScale=0.140000
     ThirdPersonMesh=StaticMesh'BWBP_JW_Static.Pin'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=3000
         DamageType=Class'BWBPJunkCollectionDE.DTpin'
         RefireTime=0.500000
         AnimRate=1.500000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_pin.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_pin.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1500
         ProjMass=20
         ProjMesh=StaticMesh'BWBP_JW_Static.pinLD'
         ProjScale=0.250000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'BWBPJunkCollectionDE.JWVan_pin.JunkThrowFireInfo0'
     ...
     PainThreshold=10
     NoUseThreshold=25
     StaticMesh=StaticMesh'BWBP_JW_Static.Pin'
     DrawScale=1.150000
}
