...
// JO_ConcretePole.
//
// Large steel pole pulled from sidewalk. Comes with attached block of concrete.
// Very devastating weapon, but slow to use.
//
// by Nolan "Dark Carnivour" Richert.
// Copyright(c) 2006 RuneStorm. All Rights Reserved.
//=============================================================================
class JO_ConcretePole extends JunkObject;

defaultproperties
{
     HandOffset=(X=2.000000,Z=-6.000000)
     PickupMesh=StaticMesh'BWBP_JW_Static.Junk.ConcretePoleLD'
     PickupDrawScale=0.400000
     SpawnPivot=(Pitch=768)
     SpawnOffset=(Z=2.000000)
     PickupMessage="You got the Concrete Pole. Smashing time!"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'BWBP_JW_Static.Junk.ConcretePole'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'BWBPJunkCollectionDE.IM_JunkConcretePole'
         HookStopFactor=1.500000
         Damage=(head=130,Limb=35,Misc=95)
         KickForce=20000
         DamageType=Class'BWBPJunkCollectionDE.DTJunkConcretePole'
         RefireTime=1.250000
         AnimRate=1.500000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JO_ConcretePole.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         ImpactManager=Class'BWBPJunkCollectionDE.IM_JunkConcretePole'
         HookStopFactor=1.500000
         Damage=(head=140,Limb=45,Misc=105)
         KickForce=35000
         DamageType=Class'BWBPJunkCollectionDE.DTJunkConcretePole'
         RefireTime=1.250000
         AnimRate=1.350000
         ...
         AnimTimedFire=ATS_Early
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JO_ConcretePole.JunkFireInfo1'

     SelectSound=(Sound=SoundGroup'BWBP_JW_Sound.Misc.Pullout-Heavy')
     FriendlyName="Concrete Pole"
     InventoryGroup=5
     ...
     StaticMesh=StaticMesh'BWBP_JW_Static.Junk.ConcretePole'
     DrawScale=0.600000
}
