...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'BWBP_JW_Static.Junk.MaceLD'
     PickupDrawScale=0.400000
     SpawnPivot=(Pitch=768)
     SpawnOffset=(Z=2.000000)
     PickupMessage="You got the Big Steel Mace."
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'BWBP_JW_Static.Junk.Mace'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'BWBPJunkCollectionDE.IM_JunkBigMace'
         HookStopFactor=1.600000
         Damage=(head=140,Limb=35,Misc=100)
         KickForce=25000
         DamageType=Class'BWBPJunkCollectionDE.DTJunkBigMace'
         RefireTime=1.100000
         AnimRate=1.400000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JO_BigSteelMace.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Early
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JO_BigSteelMace.JunkFireInfo1'
     ...
     StaticMesh=StaticMesh'BWBP_JW_Static.Junk.Mace'
     DrawScale=0.630000
}
