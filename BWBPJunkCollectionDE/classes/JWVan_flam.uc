...
// Plastic Flamingo.
//
// IT'S SO PINK IT HURTS MY EYES. 
//
// by Nolan "Dark Carnivour" Richert.
// Copyright(c) 2006 RuneStorm. All Rights Reserved.
//=============================================================================
class JWVan_flam extends JunkObject;

defaultproperties
{
     HandOffset=(X=4.000000,Z=-2.000000)
     PickupMesh=StaticMesh'BWBP_JW_Static.flamLD'
     PickupDrawScale=0.650000
     PickupMessage="You got the Plastic Flamingo. Typical suburban lawn ornament."
     ThirdPersonDrawScale=0.400000
     ThirdPersonMesh=StaticMesh'BWBP_JW_Static.flam'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=9000
         DamageType=Class'BWBPJunkCollectionDE.DTflam'
         RefireTime=0.500000
         AnimRate=1.500000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_flam.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_flam.JunkFireInfo1'

     FriendlyName="Plastic Flamingo"
     InventoryGroup=4
     ...
     StaticMesh=StaticMesh'BWBP_JW_Static.flam'
     DrawScale=0.800000
}
