...
// Greatsword.
//
// This is used to rape some pepz.
//
// by Nolan "Dark Carnivour" Richert.
// Copyright(c) 2006 RuneStorm. All Rights Reserved.
//=============================================================================
class JWVan_greatsword extends JunkObject;

defaultproperties
{
     HandOffset=(X=4.000000,Z=-6.000000)
     PickupMesh=StaticMesh'BWBP_JW_Static.greatswordLD'
     PickupDrawScale=0.400000
     SpawnOffset=(Z=2.000000)
     PickupMessage="You got the Greatsword. Slaughter some people."
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'BWBP_JW_Static.greatsword'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         Damage=(head=220,Limb=95,Misc=120)
         KickForce=30000
         DamageType=Class'BWBPJunkCollectionDE.DTgreatsword'
         RefireTime=1.100000
         AnimRate=1.400000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_greatsword.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         HookStopFactor=1.600000
         HookPullForce=100.000000
         Damage=(head=350,Limb=130,Misc=130)
         KickForce=35000
         DamageType=Class'BWBPJunkCollectionDE.DTgreatsword'
         RefireTime=1.250000
         AnimRate=1.350000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_greatsword.JunkFireInfo1'
     ...
     StaticMesh=StaticMesh'BWBP_JW_Static.greatsword'
     DrawScale=0.800000
}
