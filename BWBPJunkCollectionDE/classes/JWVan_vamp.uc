...
//=============================================================================
class JWVan_vamp extends JunkObject;
...
{
	Instigator.GiveHealth(5, Instigator.HealthMax*1.25);
	return false;
}
...
defaultproperties
{
     ...
     PickupMesh=StaticMesh'BWBP_JW_Static.vampLD'
     PickupDrawScale=0.400000
     PickupMessage="You got the Vampiristic Pick. Nosferatu!"
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'BWBP_JW_Static.vamp'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         ImpactManager=Class'BWBPJunkCollectionDE.IM_JunkCrowbar'
         HookStopFactor=1.600000
         HookPullForce=100.000000
         Damage=(head=120,Limb=25,Misc=45)
         KickForce=7000
         DamageType=Class'BWBPJunkCollectionDE.DTvamp'
         RefireTime=0.400000
         AnimRate=1.200000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_vamp.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         HookStopFactor=1.600000
         HookPullForce=100.000000
         Damage=(head=130,Limb=38,Misc=65)
         KickForce=12000
         DamageType=Class'BWBPJunkCollectionDE.DTvamp'
         RefireTime=0.800000
         AnimRate=1.250000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_vamp.JunkFireInfo1'

     Begin Object Class=JunkThrowFireInfo Name=JunkThrowFireInfo0
         projSpeed=1200
         ProjMass=25
         ProjMesh=StaticMesh'BWBP_JW_Static.vampLD'
         ProjScale=0.250000
         ...
         AnimTimedFire=ATS_Timed
     End Object
     ThrowFireInfo=JunkThrowFireInfo'BWBPJunkCollectionDE.JWVan_vamp.JunkThrowFireInfo0'

     SelectSound=(Sound=SoundGroup'BWBP_JW_Sound.Misc.Pullout-Avg')
     FriendlyName="Vampiristic Pick"
     MeleeRating=65.000000
     RangeRating=25.000000
     NoUseThreshold=80
     StaticMesh=StaticMesh'BWBP_JW_Static.vamp'
     DrawScale=1.210000
}
