...
//=============================================================================
class JWVan_cricket extends JunkObject;

defaultproperties
{
     HandOffset=(X=4.000000,Z=-2.000000)
     PickupMesh=StaticMesh'BWBP_JW_Static.cricketLD'
     PickupDrawScale=0.350000
     PickupMessage="You got the Cricket Bat. Smash some ugly faces."
     ThirdPersonDrawScale=0.250000
     ThirdPersonMesh=StaticMesh'BWBP_JW_Static.cricket'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo0
         ...
         KickForce=9000
         DamageType=Class'BWBPJunkCollectionDE.DTcricket'
         RefireTime=0.500000
         AnimRate=1.500000
     ...
     End Object
     MeleeAFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_cricket.JunkFireInfo0'
     ...
     Begin Object Class=JunkMeleeFireInfo Name=JunkFireInfo1
         ...
         AnimTimedFire=ATS_Timed
     End Object
     MeleeBFireInfo=JunkMeleeFireInfo'BWBPJunkCollectionDE.JWVan_cricket.JunkFireInfo1'

     FriendlyName="Cricket Bat"
     InventoryGroup=4
     ...
     StaticMesh=StaticMesh'BWBP_JW_Static.cricket'
     DrawScale=0.800000
}
