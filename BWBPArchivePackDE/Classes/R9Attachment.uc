...
defaultproperties
{
     TracerClasses(0)=Class'BallisticDE.TraceEmitter_Default'
     TracerClasses(1)=Class'BallisticDE.TraceEmitter_Freeze'
     TracerClasses(2)=Class'BallisticDE.TraceEmitter_R9Laser'
     TracerClasses(3)=Class'BallisticDE.TraceEmitter_Default'
     TracerClasses(4)=Class'BallisticDE.TraceEmitter_Default'
     ImpactManagers(0)=Class'BallisticDE.IM_Bullet'
     ImpactManagers(1)=Class'BallisticDE.IM_FreezeHit'
     ImpactManagers(2)=Class'BallisticDE.IM_R9Laser'
     ImpactManagers(3)=Class'BallisticDE.IM_Bullet'
     ImpactManagers(4)=Class'BallisticDE.IM_Bullet'
     MuzzleFlashClass=Class'BallisticDE.R9FlashEmitter'
