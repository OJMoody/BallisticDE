...
//=============================================================================
class HVPCMk5_TopArc extends BallisticEmitter;
...
defaultproperties
{
     Begin Object Class=SpriteEmitter Name=SpriteEmitter0
         ...
         ColorMultiplierRange=(X=(Min=1.300000,Max=1.300000),Y=(Min=0.300000,Max=0.300000),Z=(Min=0.300000,Max=0.300000))
     ...
     End Object
     Emitters(0)=SpriteEmitter'BWBPArchivePackDE.HVPCMk5_TopArc.SpriteEmitter0'
     ...
     Begin Object Class=BeamEmitter Name=BeamEmitter1
         ...
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(B=255,G=255,R=255,A=255))
         ColorMultiplierRange=(X=(Min=1.400000,Max=1.400000),Y=(Min=0.400000,Max=0.400000),Z=(Min=0.700000,Max=0.700000))
     ...
     End Object
     Emitters(1)=BeamEmitter'BWBPArchivePackDE.HVPCMk5_TopArc.BeamEmitter1'
