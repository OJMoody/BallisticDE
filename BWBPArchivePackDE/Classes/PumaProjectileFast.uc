...
defaultproperties
{
     ...
     ImpactDamage=70
     ImpactDamageType=Class'BWBPArchivePackDE.DT_PUMAGrenade'
     ImpactManager=Class'BWBPArchivePackDE.IM_PumaDet'
     TrailClass=Class'BWBPArchivePackDE.PumaProjectileFastTrail'
     MyRadiusDamageType=Class'BWBPArchivePackDE.DT_PUMARadius'
