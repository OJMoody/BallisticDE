...
defaultproperties
{
	...
	MaxSpreadFactor=2
	TraceCount=5
	TracerClass=Class'BallisticDE.TraceEmitter_MRTsix'
	...
	RangeAtten=0.250000
	DamageType=Class'BWBPArchivePackDE.DTCoachShot'
	DamageTypeHead=Class'BWBPArchivePackDE.DTCoachShot'
	DamageTypeArm=Class'BWBPArchivePackDE.DTCoachShot'
	KickForce=8000
	...
	FireRate=0.550000
	AmmoClass=Class'BWBPArchivePackDE.Ammo_CoachShells'
