...
defaultproperties
{
     ...
     MeleeFireClass=Class'BWBPArchivePackDE.CoachGunMeleeFire'
     ...
     SightOffset=(X=-8.000000,Y=2.300000,Z=8.000000)
     ...
     FireModeClass(0)=Class'BWBPArchivePackDE.CoachGunPrimaryFire'
     ...
     InventoryGroup=2
     PickupClass=Class'BWBPArchivePackDE.CoachGunPickup'
     PlayerViewOffset=(X=3.000000,Y=5.000000,Z=-6.000000)
     AttachmentClass=Class'BWBPArchivePackDE.CoachGunAttachment'
     ...
     Mesh=SkeletalMesh'BWBPArchivePack1Anim.FPm_SawnOff'
     DrawScale=1.250000
}
