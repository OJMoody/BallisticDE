...
defaultproperties
{
     ...
     DamageType=Class'BWBPArchivePackDE.DTRaygun'
     DamageTypeHead=Class'BWBPArchivePackDE.DTRaygun'
     DamageTypeArm=Class'BWBPArchivePackDE.DTRaygun'
     PenetrateForce=200
     bPenetrate=True
     MuzzleFlashClass=Class'BWBPArchivePackDE.RaygunMuzzleFlash'
     ...
     FireEndAnim=
     FireRate=0.085000
     AmmoClass=Class'BWBPArchivePackDE.Ammo_RaygunCells'
