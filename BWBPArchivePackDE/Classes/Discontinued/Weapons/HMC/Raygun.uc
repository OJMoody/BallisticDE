...
defaultproperties
{
     ...
     FireModeClass(0)=Class'BWBPArchivePackDE.E23SecondaryFire'
     FireModeClass(1)=Class'BWBPArchivePackDE.RaygunSecondaryFire'
     ...
     InventoryGroup=5
     GroupOffset=1
     PickupClass=Class'BWBPArchivePackDE.RaygunPickup'
     PlayerViewOffset=(X=5.000000,Z=-5.000000)
     AttachmentClass=Class'BWBPArchivePackDE.RaygunAttachment'
