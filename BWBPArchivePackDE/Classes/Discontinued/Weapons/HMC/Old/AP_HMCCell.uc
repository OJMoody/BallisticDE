...
//=============================================================================
class AP_HMCCell extends BallisticAmmoPickup;

defaultproperties
{
     AmmoAmount=50
     InventoryType=Class'BWBPArchivePackDE.Ammo_HMCCells'
     ...
     DrawScale=0.250000
     Skins(0)=Texture'BallisticRecolors4.XavPlasCannon.XavPackSkin'
     Skins(1)=Texture'BallisticRecolors4.XavPlasCannon.XavAmmoSkin'
