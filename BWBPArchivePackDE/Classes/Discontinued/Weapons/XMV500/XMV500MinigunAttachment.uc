...
defaultproperties
{
     FireClass=Class'BWBPArchivePackDE.XMV500MinigunPrimaryFire'
     MuzzleFlashClass=Class'BallisticDE.XK2FlashEmitter'
     AltMuzzleFlashClass=Class'BallisticDE.XK2FlashEmitter'
     ImpactManager=Class'BWBPArchivePackDE.IM_IncendiaryBulletMinigun'
     BrassClass=Class'BallisticDE.Brass_Minigun'
     TracerClass=Class'BWBPArchivePackDE.TraceEmitter_Incendiary'
     ...
     ReloadAnimRate=0.9500000
     DrawScale=0.300000
     Skins(0)=Texture'BallisticRecolors4.XMV500.XMV500_Main'
     Skins(1)=Texture'BallisticRecolors4.XMV500.XMV500_Main'
     Skins(2)=Shader'BallisticRecolors4.XMV500.XMV500_Barrels_SD'
     Skins(3)=Texture'BallisticRecolors4.XMV500.XMV500_Main'
}
