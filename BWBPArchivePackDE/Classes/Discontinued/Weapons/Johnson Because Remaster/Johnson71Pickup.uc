...
//=============================================================================
class Johnson71Pickup extends BallisticWeaponPickup
	placeable;
...
defaultproperties
{
     ...
     InventoryType=Class'BWBPArchivePackDE.Johnson71Shotgun'
     RespawnTime=20.000000
     PickupMessage="You picked up the Johnson 71 Combat Flare Gun."
