...
//-----------------------------------------------------------
class Johnson71Projectile extends BallisticGrenade;
...
defaultproperties
{
     ...
     ImpactDamage=110
     ImpactDamageType=Class'BWBPArchivePackDE.DT_Johnson71'
     ImpactManager=Class'BWBPArchivePackDE.IM_FlareExplode'
     TrailClass=Class'BWBPArchivePackDE.Johnson71RocketTrail'
     TrailOffset=(X=-8.000000)
     MyRadiusDamageType=Class'BWBPArchivePackDE.DT_Johnson71Radius'
     ...
     MyDamageType=Class'BWBPArchivePackDE.DT_Johnson71Radius'
