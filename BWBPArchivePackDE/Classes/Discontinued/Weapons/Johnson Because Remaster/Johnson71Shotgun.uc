...
//=============================================================================
class Johnson71Shotgun extends BallisticProShotgun;
...
defaultproperties
{
     ...
     SightPivot=(Pitch=0)
     SightOffset=(X=75.000000,Y=54.000000,Z=49.500000)
	 SightDisplayFOV=30
     ...
     FireModeClass(0)=Class'BWBPArchivePackDE.Johnson71PrimaryFire'
     FireModeClass(1)=Class'BWBPArchivePackDE.Johnson71SecondaryFire'
     ...
     InventoryGroup=8
     GroupOffset=8
     PickupClass=Class'BWBPArchivePackDE.Johnson71Pickup'
     PlayerViewOffset=(Y=-10.000000,Z=-40.000000)
     AttachmentClass=Class'BWBPArchivePackDE.Johnson71Attachment'
     IconMaterial=Texture'BallisticRecolors3TexPro.SK410.SmallIcon_SK410'
     IconCoords=(X2=127,Y2=35)
     ItemName="[B] Johnson 71"
     LightType=LT_Pulse
     ...
     Mesh=SkeletalMesh'BWBPArchivePack2Anim.Johnson_FP'
     DrawScale=8.000000
}
