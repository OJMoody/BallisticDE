...
defaultproperties
{
     ...
     MeleeFireClass=Class'BWBPArchivePackDE.M763MeleeFire'
     ...
     FireModeClass(0)=Class'BWBPArchivePackDE.M763PrimaryFire'
     FireModeClass(1)=Class'BWBPArchivePackDE.MAG78SecondaryFire'
     AIRating=0.750000
     ...
     InventoryGroup=7
     GroupOffset=2
     PickupClass=Class'BWBPArchivePackDE.M763Pickup'
     PlayerViewOffset=(Y=-10.000000,Z=-40.000000)
     AttachmentClass=Class'BWBPArchivePackDE.M763Attachment'
