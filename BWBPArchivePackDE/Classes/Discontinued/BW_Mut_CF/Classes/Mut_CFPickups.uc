...
defaultproperties
{
     ...
     FriendlyName="BallisticPro: Manual Pickups (No Animations)"
     Description="This Mutator enables Far Cry 2 alike weapon pickups and Borderlands alike overlays for the thrown pickups. No Animations are played when picking up the weapons"
}
