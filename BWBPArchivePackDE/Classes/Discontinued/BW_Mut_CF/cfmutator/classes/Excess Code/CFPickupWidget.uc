...
simulated function InitWidget()
{
	...
	if(bwPickUp != none)
	{
		...
		bwinvGroup=class<BallisticWeapon>(bwPickUp.InventoryType).default.BallisticInventoryGroup;
...
defaultproperties
{
     ...
     InventoryGroupNameL(2)="- Spread -"
     InventoryGroupNameL(3)="- Sub-machinegun -"
     InventoryGroupNameL(4)="- Assault -"
     InventoryGroupNameL(5)="- Heavy Machingun -"
     InventoryGroupNameL(6)="- Sniper -"
     InventoryGroupNameL(7)="- Rocket / Hazardous -"
     InventoryGroupNameL(8)="- Special / HiTech -"
