...
//=============================================================================
class RGPRock extends BallisticProjectile;
...
defaultproperties
{
     ...
     ImpactDamage=90
     ImpactDamageType=Class'BWBPArchivePackDE.DTRGPBazookaRadius'
     ImpactManager=Class'BWBPArchivePackDE.IM_RPG'
     bRandomStartRotaion=False
     AccelSpeed=18000.000000
     TrailClass=Class'BWBPArchivePackDE.RGPRocketTrail'
     TrailOffset=(X=-14.000000)
     MyRadiusDamageType=Class'BWBPArchivePackDE.DTRGPBazookaRadius'
     ...
     MyDamageType=Class'BWBPArchivePackDE.DTRGPBazooka'
     LightType=LT_Steady
     ...
     StaticMesh=StaticMesh'BWWeaponPackArchive-Static.RPG.Rocket'
     bDynamicLight=True
     AmbientSound=Sound'BWWeaponPack2Archive-Sounds.RPG.RPGFly'
     DrawScale=0.500000
     SoundVolume=192
