...
defaultproperties
{
	 ...
	 FireModeClass(0)=Class'BWBPArchivePackDE.MARS4PrimaryFire'
     FireModeClass(1)=Class'BWBPArchivePackDE.MARS4SecondaryFire'
     ...
     InventoryGroup=4
     AttachmentClass=Class'BWBPArchivePackDE.MARS4Attachment'
     ...
     DrawScale=0.300000
	 PickupClass=Class'BWBPArchivePackDE.MARS4Pickup'
