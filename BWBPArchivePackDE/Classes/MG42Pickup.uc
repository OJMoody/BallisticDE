...
static function StaticPrecache(LevelInfo L)
{
	...
	L.AddPrecacheStaticMesh(StaticMesh'BWXWeaponArchiveStatics.MGA88s.MGA88sAmmoBox');
    L.AddPrecacheStaticMesh(StaticMesh'BWXWeaponArchiveStatics.MGA88s.MGA88sGun');
}
...
{
    //Level.AddPrecacheStaticMesh(StaticMesh'BWXWeaponArchiveStatics.MGA88s.MGA88sAmmoBox');
    Level.AddPrecacheStaticMesh(StaticMesh'BWXWeaponArchiveStatics.MGA88s.MGA88sGun');
}

defaultproperties
{
     bOnSide=False
     LowPolyStaticMesh=StaticMesh'BWXWeaponArchiveStatics.MGA88s.MGA88sGun'
     PickupDrawScale=2.500000
     StandUp=(Y=0.800000)
     InventoryType=Class'BWBPArchivePackDE.MG42Machinegun'
     RespawnTime=20.000000
     PickupMessage="You picked up the MG43 machinegun."
     PickupSound=Sound'BallisticSounds2.M353.M353-Putaway'
     StaticMesh=StaticMesh'BWXWeaponArchiveStatics.MGA88s.MGA88sGun'
     bOrientOnSlope=True
     Physics=PHYS_None
