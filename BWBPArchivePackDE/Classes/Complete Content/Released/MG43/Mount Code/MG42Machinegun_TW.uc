...
//=============================================================================
class MG42Machinegun_TW extends BallisticMachinegun
    HideDropDown
	CacheExempt;
...
defaultproperties
{
     ...
     FireModeClass(0)=Class'BWBPArchivePackDE.MG42TW_PrimaryFire'
     FireModeClass(1)=Class'BWBPArchivePackDE.MG42TertiaryFire'
     SelectAnim="Deploy"
     ...
     ItemName="MG42 Machinegun Turret"
     LightType=LT_Pulse
     ...
     Mesh=SkeletalMesh'BWXWeaponAnims.MGA88-FP_Turret'
     DrawScale=0.600000
