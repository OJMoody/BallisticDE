...
{
	Level.AddPrecacheStaticMesh(StaticMesh'BWSkrithRecolorsArchive2Static.SkrithMinigun.SME_SM_Main');
	Level.AddPrecacheStaticMesh(StaticMesh'BWSkrithRecolorsArchive2Static.SkrithMinigun.SME_SM_Main');
}
...
{
     bOnSide=False
     LowPolyStaticMesh=StaticMesh'BWSkrithRecolorsArchive2Static.SkrithMinigun.SME_SM_Main'
     ...
     StaticMesh=StaticMesh'BWSkrithRecolorsArchive2Static.SkrithMinigun.SME_SM_Main'
     bOrientOnSlope=True
     Physics=PHYS_None
     DrawScale=0.100000
