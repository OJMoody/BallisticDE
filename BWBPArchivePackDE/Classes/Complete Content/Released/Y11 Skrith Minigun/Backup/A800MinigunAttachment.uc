...
defaultproperties
{
     FireClass=Class'BWBPArchivePackDE.A800MinigunPrimaryFire'
     ...
     FlashMode=MU_Both
     LightMode=MU_Both
     TracerClass=Class'BallisticDE.TraceEmitter_A42Beam'
     bHeavy=True
     bRapidFire=True
     Mesh=SkeletalMesh'BWSkrithRecolors2Anim.SkrithMinigun-3rd'
     DrawScale=0.300000
}
