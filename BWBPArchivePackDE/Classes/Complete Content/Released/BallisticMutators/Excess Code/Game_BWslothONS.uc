...
// Game_BWslothONS.
//=============================================================================
class Game_BWslothONS extends ONSOnslaughtGame config(BallisticGrobtators);
...
defaultproperties
{
     ...
     GameName="BW-Sloth ONS"
     Description="Sloth version of Ballistic ONS."
     DecoTextName="BallisticGrobtators.Game_BWslothONS"
}
