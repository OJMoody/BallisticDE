...
// Game_BWslothTDM.
//=============================================================================
class Game_BWslothTDM extends xTeamGame config(BallisticGrobtators);
...
defaultproperties
{
     ...
     GameName="BW-Sloth TDM"
     Description="Sloth version of Ballistic TDM."
     DecoTextName="BallisticGrobtators.Game_BWslothTDM"
}
