...
// Game_BWslothBR.
//=============================================================================
class Game_BWslothBR extends xBombingRun config(BallisticGrobtators);
...
defaultproperties
{
     ...
     GameName="BW-Sloth BR"
     Description="Sloth version of Ballistic BR."
     DecoTextName="BallisticGrobtators.Game_BWslothBR"
}
