...
defaultproperties
{
     ImpactManager=Class'BWBPArchivePackDE.IM_SkrithStaffPower'
     PenetrateManager=Class'BWBPArchivePackDE.IM_SkrithStaffPower'
     bRandomStartRotaion=False
     TrailClass=Class'BWBPArchivePackDE.SkrithStaffPowerTrail'
     MyRadiusDamageType=Class'BWBPArchivePackDE.DT_SkrithStaffPower'
     bTearOnExplode=False
     DamageTypeHead=Class'BWBPArchivePackDE.DT_SkrithStaffPower'
     ...
     MyDamageType=Class'BWBPArchivePackDE.DT_SkrithStaffPower'
     LightType=LT_Steady
     ...
     LifeSpan=16.000000
     Skins(0)=FinalBlend'BallisticRecolorsArchive5.A73b.A73BPowerF2'
     Skins(1)=FinalBlend'BallisticRecolorsArchive5.A73b.A73BPowerF1'
     Style=STY_Additive
     SoundVolume=255
