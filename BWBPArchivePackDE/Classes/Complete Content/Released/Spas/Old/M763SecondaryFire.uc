...
//=============================================================================
class M763SecondaryFire extends BallisticProShotgunFire;
...
defaultproperties
{
     ...
     RangeAtten=0.25000
     DamageType=Class'BallisticDE.DTM763Shotgun'
     DamageTypeHead=Class'BallisticDE.DTM763ShotgunHead'
     DamageTypeArm=Class'BallisticDE.DTM763Shotgun'
     KickForce=5000
     PenetrateForce=100
     bPenetrate=True
     MuzzleFlashClass=Class'BallisticDE.M763FlashEmitter'
     ...
     FireRate=0.750000
     AmmoClass=Class'BallisticDE.Ammo_12Gauge'
