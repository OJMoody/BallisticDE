...
defaultproperties
{
     ...
     FireModeClass(0)=Class'BallisticDE.M763PrimaryFire'
     FireModeClass(1)=Class'BallisticDE.M763SecondaryFire'
     AIRating=0.750000
     ...
     InventoryGroup=7
     GroupOffset=2
     PickupClass=Class'BallisticDE.M763Pickup'
     PlayerViewOffset=(Y=12.000000,Z=-12.000000)
     AttachmentClass=Class'BallisticDE.M763Attachment'
     IconMaterial=Texture'BallisticUI2.Icons.SmallIcon_M763'
     IconCoords=(X2=127,Y2=31)
	 ItemName="[B] SPAS Assault Shotgun"
     ...
     Mesh=SkeletalMesh'BWWeaponPackAnims.SPAS'
     DrawScale=0.500000
}
