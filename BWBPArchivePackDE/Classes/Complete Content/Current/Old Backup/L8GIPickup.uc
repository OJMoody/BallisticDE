...
{
	Level.AddPrecacheMaterial(Texture'BWSkrithRecolors2Tex.NTOV.NTOVSkin');

}

simulated function UpdatePrecacheStaticMeshes()
{
	//Level.AddPrecacheStaticMesh(StaticMesh'BWSkrithRecolors2Static.NTOV.NTOVPickup');
...
defaultproperties
{
     ...
     Physics=PHYS_None
     DrawScale=0.350000
     Skins(0)=Texture'BWSkrithRecolors2Tex.AmmoPack.L8GISkin'
