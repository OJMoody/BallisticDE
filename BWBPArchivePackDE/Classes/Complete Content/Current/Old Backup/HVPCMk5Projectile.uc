...
defaultproperties
{
     ImpactManager=Class'BWBPArchivePackDE.IM_HVPCProjectile'
     PenetrateManager=Class'BWBPArchivePackDE.IM_HVPCProjectile'
     bPenetrate=True
     bRandomStartRotaion=False
     AccelSpeed=90000.000000
     TrailClass=Class'BWBPArchivePackDE.A73BTrailEmitter'
     MyRadiusDamageType=Class'BWBPArchivePackDE.DTPlasmaCharge'
     bUsePositionalDamage=True
     DamageHead=165
     DamageLimb=35
     DamageTypeHead=Class'BWBPArchivePackDE.DTPlasmaChargeHead'
     ...
     MyDamageType=Class'BWBPArchivePackDE.DTPlasmaCharge'
     LightType=LT_Steady
     ...
     Skins(0)=FinalBlend'BallisticRecolors5.A73b.A73BProjFinal'
     Skins(1)=FinalBlend'BallisticRecolors5.A73b.A73BProj2Final'
     Style=STY_Additive
     SoundVolume=255
