...
defaultproperties
{
     ...
     BigIconMaterial=Texture'BallisticRecolors4.BlkOpsBlade.BigIcon_WristBld'
     ...
     bNoMag=True
     GunLength=0.000000
     FireModeClass(0)=Class'BWBPArchivePackDE.BlackOpsWristBladePrimaryFire'
     FireModeClass(1)=Class'BWBPArchivePackDE.BlackOpsWristBladeSecondaryFire'
     ...
     GroupOffset=5
     PickupClass=Class'BWBPArchivePackDE.BlackOpsWristBladePickup'
     PlayerViewOffset=(X=35.000000,Y=50.000000,Z=-40.000000)
     BobDamping=1.000000
     AttachmentClass=Class'BWBPArchivePackDE.BlackOpsWristBladeAttachment'
     IconMaterial=Texture'BallisticRecolors4.BlkOpsBlade.SmallIcon_WristBld'
     IconCoords=(X2=127,Y2=31)
     ItemName="X5W Black Ops Blade"
     Mesh=SkeletalMesh'BWBPArchivePack1Anim.BlackOpsWristBlade'
     DrawScale=1.250000
}
