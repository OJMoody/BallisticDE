...
simulated event WeaponTick (float DT)
{
	...
	SetBoneRotation('BarrelBase3', BT);
...
defaultproperties
{
     ...
     BigIconMaterial=Texture'BWSkrithRecolors2Tex.SkrithMinigun.BigIcon_SkrithMinigun'
     ...
     SightPivot=(Pitch=1024,Roll=8704)
     SightOffset=(X=-10.000000,Y=-5.300000,Z=20.000000)
     ...
     //RecoilYCurve=(Points=(,(InVal=0.200000,OutVal=0.600000),(InVal=1.000000,OutVal=1.000000)))
     ...
     Description="A800 'Behemoth' Skrith Minigun|Manuacturer: Unknown Skrith Engineers|Primary: Auto Fire Beams|Secondary: Auto Fire Projectile||Recent reports indicate that the Skrith have developed their own minigun in order to counter those often used by human soldiers. Based on witness statements, the A800 'Brute' is capable of shooting both energy beams and projectiles quickly enough to tear apart the most well-armored targets. Recovered batteries have been examined, and it seems that the Skrith initially experimented with increasing the power output of their famous rechargable energy cells. Though the Skrith technically succeeded, the cells recharge too slowly to be a consistent source of ammo, but on the chance that a Skrith warrior was given a low-charge cell, the Skrith minigun is able to compensate. As the weapon was intended for larger Skrith, it does not have any sort of stand to improve accuracy, limiting its use by human soldiers."
     ...
     IconMaterial=Texture'BWSkrithRecolors2Tex.SkrithMinigun.SmallIcon_SkrithMinigun'
     ...
     Mesh=SkeletalMesh'BWSkrithRecolors2Anim.SkrithMinigun'
     DrawScale=0.600000
