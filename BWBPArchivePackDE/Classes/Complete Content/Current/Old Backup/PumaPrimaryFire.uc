...
defaultproperties
{
     LastProjectileClass=Class'BWBPArchivePackDE.PumaProjectile'
     ...
     BallisticFireSound=(Sound=Sound'PackageSounds4A.PUMA.PUMA-Fire')
     bSplashDamage=True
     ...
     ProjectileClass=Class'BWBPArchivePackDE.PumaProjectile'
