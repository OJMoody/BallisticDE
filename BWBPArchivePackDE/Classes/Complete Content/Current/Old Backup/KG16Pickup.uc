...
{
    Level.AddPrecacheStaticMesh(StaticMesh'BWXWeaponStatics.KG16.KG16Brass');
    Level.AddPrecacheStaticMesh(StaticMesh'BWXWeaponStatics.KG16.KG16Pickup');
    Level.AddPrecacheStaticMesh(StaticMesh'BWXWeaponStatics.KG16.KG16Mag');
}

defaultproperties
{
     bOnSide=False
     LowPolyStaticMesh=StaticMesh'BWXWeaponStatics.KG16.KG16Pickup'
     ...
     StaticMesh=StaticMesh'BWXWeaponStatics.KG16.KG16Pickup'
     Physics=PHYS_None
     DrawScale=0.150000
