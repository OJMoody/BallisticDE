...
defaultproperties
{
	 ...
	 BringUpSound=(Sound=Sound'PackageSounds4.NEX.NEX-Pullout',Volume=2.000000)
     ...
     BigIconMaterial=Texture'BallisticRecolors4.NEX.BigIcon_Nex'
     ...
     GunLength=0.000000
     bAimDisabled=True
     FireModeClass(0)=Class'BWBPArchivePackDE.N3XPlazPrimaryFire'
     FireModeClass(1)=Class'BWBPArchivePackDE.N3XPlazSecondaryFire'
     ...
     IconMaterial=Texture'BallisticRecolors4.NEX.SmallIcon_Nex'
     IconCoords=(X2=127,Y2=31)
     ItemName="N3X Plaz Edge Sword"
     Mesh=SkeletalMesh'BWBPArchivePack1Anim.NEXPlasEdge'
     DrawScale=3.000000
     bFullVolume=True
     SoundVolume=64
