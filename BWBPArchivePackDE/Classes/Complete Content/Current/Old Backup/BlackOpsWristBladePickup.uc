...
{
	Level.AddPrecacheMaterial(Texture'BallisticRecolors4.BlkOpsBlade.BlkOpsBlade');
...
{
	Level.AddPrecacheStaticMesh(StaticMesh'BallisticRecolors4Static.X5W.X5WPickup');
}

defaultproperties
{
     LowPolyStaticMesh=StaticMesh'BallisticRecolors4Static.X5W.X5WPickup'
     ...
     StaticMesh=StaticMesh'BallisticRecolors4Static.X5W.X5WPickup'
     Physics=PHYS_None
     DrawScale=0.200000
