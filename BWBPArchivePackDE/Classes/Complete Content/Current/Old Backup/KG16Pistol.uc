...
simulated function DrawLaserSight ( Canvas Canvas )
{
	...
	Loc = GetBoneCoords('SlideR').Origin;
...
defaultproperties
{
     ...
     SightOffset=(X=-20.000000,Y=35.00000,Z=18.00000)
     ...
     PlayerViewOffset=(X=0.000000,Y=-10.000000,Z=-20.000000)
     ...
     Mesh=SkeletalMesh'BWXWeaponAnims.KG16-FP'
     DrawScale=1.000000
}
