...
{
	Level.AddPrecacheMaterial(Texture'BallisticRecolors4.M30A2.M30A2-SA');
	Level.AddPrecacheMaterial(Texture'BallisticRecolors4.M30A2.M30A2-SB');
	Level.AddPrecacheMaterial(Texture'BallisticRecolors4.M30A2.M30A2-Laser');
	Level.AddPrecacheMaterial(Texture'BallisticRecolors4.M30A2.M30A2-Gauss');
...
defaultproperties
{
     LowPolyStaticMesh=StaticMesh'BallisticRecolors4StaticA.MARS.MARS3_Pickup'
     ...
     StaticMesh=StaticMesh'BallisticRecolors4StaticA.MARS.MARS3_Pickup'
     Physics=PHYS_None
     DrawScale=0.250000
     Skins(0)=Texture'BallisticRecolors4A.MARS.F2000-Irons'
     Skins(1)=Texture'BallisticRecolors4A.LK05.LK05-EOTech'
     Skins(2)=Texture'BallisticRecolors4A.MARS.F2000-Misc'
