...
{
	Level.AddPrecacheMaterial(Texture'BallisticRecolors4.M1911.RS04-Main');
}
simulated function UpdatePrecacheStaticMeshes()
{
	Level.AddPrecacheStaticMesh(StaticMesh'BallisticRecolors4Static.RS04.RS04Pickup');
}

defaultproperties
{
     LowPolyStaticMesh=StaticMesh'BallisticRecolors4Static.RS04.RS04Pickup'
     ...
     StaticMesh=StaticMesh'BallisticRecolors4Static.RS04.RS04Pickup'
     Physics=PHYS_None
     DrawScale=0.620000
