...
//=============================================================================
class A51Thrown extends BallisticPineapple;
...
{
     ImpactDamage=15
     ImpactDamageType=Class'BWBPArchivePackDE.DTA51Grenade'
     ImpactManager=Class'BWBPArchivePackDE.IM_AcidGrenade'
     TrailOffset=(X=1.600000,Z=6.400000)
     MyRadiusDamageType=Class'BWBPArchivePackDE.DTA51Pool'
     ...
     StaticMesh=StaticMesh'BWSkrithRecolors1Static.SkrithGrenadeProj'
     DrawScale=0.500000
}
