...
function GiveTo(Pawn Other, optional Pickup Pickup)
{
	...
	if(Instigator.FindInventoryType(class'BWBPRecolorsDE.ChaffGrenadeWeapon')!=None )
	{
		W = Spawn(class'BWBPRecolorsDE.ChaffGrenadeWeapon',,,Instigator.Location);
		if( W != None)
		{
			W.GiveTo(Instigator);
...
defaultproperties
{
     ...
     GrenSlideSound=Sound'PackageSounds4A.MJ51.MJ51-GrenLock'
     ClipInSoundEmpty=Sound'PackageSounds4A.MJ51.MJ51-MagInEmpty'
     BulletBone="Bullet1"
     BulletBone2="Bullet2"
     TeamSkins(0)=(RedTex=Shader'BallisticWeapons2.Hands.RedHand-Shiny',BlueTex=Shader'BallisticWeapons2.Hands.BlueHand-Shiny')
     AIReloadTime=1.000000
     BigIconMaterial=Texture'BallisticRecolors5A.M4A1.BigIcon_M4'
     BCRepClass=Class'BallisticDE.BallisticReplicationInfo'
     bWT_Bullet=True
     SpecialInfo(0)=(Info="240.0;20.0;0.9;75.0;0.8;0.7;0.2")
     BringUpSound=(Sound=Sound'PackageSounds4A.MJ51.MJ51-PullOut',Volume=2.200000)
     PutDownSound=(Sound=Sound'PackageSounds4A.MJ51.MJ51-Putaway',Volume=2.200000)
     CockSound=(Sound=Sound'PackageSounds4A.MJ51.MJ51-Cock',Volume=2.200000)
     ClipHitSound=(Sound=Sound'PackageSounds4A.MJ51.MJ51-MagIn',Volume=4.800000)
     ClipOutSound=(Sound=Sound'PackageSounds4A.MJ51.MJ51-MagOut',Volume=4.800000)
     ClipInFrame=0.650000
     WeaponModes(1)=(ModeName="Automatic",ModeID="WM_FullAuto")
     WeaponModes(2)=(ModeName="Burst",ModeID="WM_Burst",Value=3.000000)
     WeaponModes(3)=(ModeName="Semi-Auto",ModeID="WM_SemiAuto",Value=1.000000)
     CurrentWeaponMode=1
     ...
     Mesh=SkeletalMesh'BWBPArchivePack2Anim.M4A1Carbine_FP'
     DrawScale=0.30000
}
