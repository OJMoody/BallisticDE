...
//=============================================================================
class SkrithStaffFlashEmitter extends BallisticEmitter;
...
defaultproperties
{
     Begin Object Class=MeshEmitter Name=MeshEmitter2
         ...
         ColorScale(2)=(RelativeTime=0.235714,Color=(G=96,R=96,A=255))
     ...
     End Object
     Emitters(0)=MeshEmitter'BWBPArchivePackDE.SkrithStaffFlashEmitter.MeshEmitter2'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter10
         ...
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=0.100000,Color=(B=255,G=255,R=255,A=255))
         ColorScale(2)=(RelativeTime=0.221429,Color=(G=96,R=96,A=255))
         ...
         SpawnOnTriggerPPS=500000.000000
     End Object
     Emitters(1)=SpriteEmitter'BWBPArchivePackDE.SkrithStaffFlashEmitter.SpriteEmitter10'
     ...
     Begin Object Class=SpriteEmitter Name=SpriteEmitter1
         ...
         TriggerDisabled=False
         ColorScale(0)=(Color=(B=255,G=255,R=255,A=255))
         ColorScale(1)=(RelativeTime=1.000000,Color=(G=255,R=200,A=255))
     ...
     End Object
     Emitters(2)=SpriteEmitter'BWBPArchivePackDE.SkrithStaffFlashEmitter.SpriteEmitter1'
