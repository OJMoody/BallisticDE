...
//===========================================================================
class R9HeatManager extends BallisticEmitter;
...
{
     MaxHeat=150.000000
     HeatDeclineDelay=1.000000
     Decay=5.000000
     DecayInterval=0.350000
     Begin Object Class=SpriteEmitter Name=R9LasSmoke
         FadeOut=True
         FadeIn=True
         SpinParticles=True
         UseSizeScale=True
     ...
     End Object
     Emitters(0)=SpriteEmitter'BWBPArchivePackDE.R9HeatManager.R9LasSmoke'
